 ...
 *         &lt;element name="Properties" type="{http://www.opentravel.org/OTA/2003/05}PropertiesType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "", propOrder = {
    "pos",
    "properties",
    "areasOrCriteriaOrTPAExtensions",
    "warnings",
    "errors",
    "success"
})
@XmlRootElement(name = "OTA_HotelSearchRS")
public class OTAHotelSearchRS {
    ...
    @XmlElements({
        ...
        @XmlElement(name = "Criteria", type = HotelSearchCriteriaType.class),
        @XmlElement(name = "TPA_Extensions", type = TPAExtensionsType.class)
    })
    protected List<Object> areasOrCriteriaOrTPAExtensions;
    ...
    /**
     * Gets the value of the areasOrCriteriaOrTPAExtensions property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the areasOrCriteriaOrTPAExtensions property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAreasOrCriteriaOrTPAExtensions().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getAreasOrCriteriaOrTPAExtensions() {
        if (areasOrCriteriaOrTPAExtensions == null) {
            areasOrCriteriaOrTPAExtensions = new ArrayList<Object>();
        }
        return this.areasOrCriteriaOrTPAExtensions;
    }
