...
/**
 * <p>Classe Java de ArrayOfOfferTypeInventory complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="ArrayOfOfferTypeInventory"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ArrayOfOfferTypeInventory", propOrder = {
    "inventory"
})
public class ArrayOfOfferTypeInventory {

    @XmlElement(name = "Inventory")
    protected List<ArrayOfOfferTypeInventory.Inventory> inventory;
     ...
     * {@link ArrayOfOfferTypeInventory.Inventory }
     * 
     * 
     */
    public List<ArrayOfOfferTypeInventory.Inventory> getInventory() {
        if (inventory == null) {
            inventory = new ArrayList<ArrayOfOfferTypeInventory.Inventory>();
        }
