    ...
    implements Serializable
{
    ...
    protected List<PkgPassengerListItem.SpecialNeed> specialNeed = new Vector<PkgPassengerListItem.SpecialNeed>();
    ...
    public List<PkgPassengerListItem.SpecialNeed> getSpecialNeed() {
        if (specialNeed == null) {
            specialNeed = new Vector<PkgPassengerListItem.SpecialNeed>();
        }
