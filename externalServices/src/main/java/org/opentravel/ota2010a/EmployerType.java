    ...
    implements Serializable
{
    ...
    protected List<CompanyNameType> relatedEmployer = new Vector<CompanyNameType>();
    ...
    protected List<FreeTextType> internalRefNmbr = new Vector<FreeTextType>();
    ...
    public List<CompanyNameType> getRelatedEmployer() {
        if (relatedEmployer == null) {
            relatedEmployer = new Vector<CompanyNameType>();
        }
    ...
    public List<FreeTextType> getInternalRefNmbr() {
        if (internalRefNmbr == null) {
            internalRefNmbr = new Vector<FreeTextType>();
        }
