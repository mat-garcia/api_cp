...
@XmlSeeAlso({
    ...
    org.opentravel.ota2010a.VehicleLocationServicesOfferedType.OnLocationServices.OnLocationService.OnLocServiceCharges.OnLocServiceCharge.class,
    org.opentravel.ota2010a.VehicleLocationServicesOfferedType.OffLocationServices.OffLocationService.OffLocServiceCharges.OffLocServiceCharge.class,
    org.opentravel.ota2010a.VehicleLocationServicesOfferedType.SpecialEquipments.SpecialEquipment.EquipCharges.EquipCharge.class,
    org.opentravel.ota2010a.VehicleLocationAdditionalFeesType.Fees.Fee.class,
    org.opentravel.ota2010a.VehicleLocationAdditionalFeesType.Surcharges.Surcharge.class,
    org.opentravel.ota2010a.VehicleLocationAdditionalFeesType.MiscellaneousCharges.MiscellaneousCharge.class
})
    ...
    implements Serializable
{
    ...
    protected List<VehicleChargeType.Calculation> calculation = new Vector<VehicleChargeType.Calculation>();
    ...
    public List<VehicleChargeType.Calculation> getCalculation() {
        if (calculation == null) {
            calculation = new Vector<VehicleChargeType.Calculation>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<VehicleChargeType.TaxAmounts.TaxAmount> taxAmount = new Vector<VehicleChargeType.TaxAmounts.TaxAmount>();
        ...
        public List<VehicleChargeType.TaxAmounts.TaxAmount> getTaxAmount() {
            if (taxAmount == null) {
                taxAmount = new Vector<VehicleChargeType.TaxAmounts.TaxAmount>();
            }
