    ...
    implements Serializable
{
    ...
    protected List<CustomerPrimaryAdditionalType.Additional> additional = new Vector<CustomerPrimaryAdditionalType.Additional>();
    ...
    public List<CustomerPrimaryAdditionalType.Additional> getAdditional() {
        if (additional == null) {
            additional = new Vector<CustomerPrimaryAdditionalType.Additional>();
        }
