 ...
 *           &lt;element name="ReservationPayment" maxOccurs="9" minOccurs="0"&gt;
 *             &lt;complexType&gt;
 *               &lt;complexContent&gt;
 *                 &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                   &lt;sequence&gt;
 ...
 *                               &lt;element name="Warnings" type="{http://www.opentravel.org/OTA/2003/05}WarningsType" minOccurs="0"/&gt;
 *                             &lt;/sequence&gt;
 *                             &lt;attribute name="ReferenceID" type="{http://www.opentravel.org/OTA/2003/05}StringLength1to32" /&gt;
 *                           &lt;/extension&gt;
 *                         &lt;/complexContent&gt;
 *                       &lt;/complexType&gt;
 *                     &lt;/element&gt;
...
@XmlRootElement(name = "OTA_CruisePaymentRS")
public class OTA_CruisePaymentRS
    implements Serializable
{
    ...
    @XmlElement(name = "ReservationPayment")
    protected List<OTA_CruisePaymentRS.ReservationPayment> reservationPayment = new Vector<OTA_CruisePaymentRS.ReservationPayment>();
     ...
     * {@link OTA_CruisePaymentRS.ReservationPayment }
     * 
     * 
     */
    public List<OTA_CruisePaymentRS.ReservationPayment> getReservationPayment() {
        if (reservationPayment == null) {
            reservationPayment = new Vector<OTA_CruisePaymentRS.ReservationPayment>();
        }
        ...
        implements Serializable
    {
        ...
        protected OTA_CruisePaymentRS.ReservationPayment.ReservationID reservationID;
        @XmlElement(name = "PaymentDetail", required = true)
        protected List<OTA_CruisePaymentRS.ReservationPayment.PaymentDetail> paymentDetail = new Vector<OTA_CruisePaymentRS.ReservationPayment.PaymentDetail>();
         ...
         * @return
         *     possible object is
         *     {@link OTA_CruisePaymentRS.ReservationPayment.ReservationID }
         *     
         */
        public OTA_CruisePaymentRS.ReservationPayment.ReservationID getReservationID() {
         ...
         *     
         */
        public void setReservationID(OTA_CruisePaymentRS.ReservationPayment.ReservationID value) {
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link OTA_CruisePaymentRS.ReservationPayment.PaymentDetail }
         * 
         * 
         */
        public List<OTA_CruisePaymentRS.ReservationPayment.PaymentDetail> getPaymentDetail() {
            if (paymentDetail == null) {
                paymentDetail = new Vector<OTA_CruisePaymentRS.ReservationPayment.PaymentDetail>();
            }
