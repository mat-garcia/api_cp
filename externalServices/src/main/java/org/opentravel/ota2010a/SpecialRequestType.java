    ...
    implements Serializable
{
    ...
    protected List<SpecialRequestType.SpecialRequest> specialRequest = new Vector<SpecialRequestType.SpecialRequest>();
    ...
    public List<SpecialRequestType.SpecialRequest> getSpecialRequest() {
        if (specialRequest == null) {
            specialRequest = new Vector<SpecialRequestType.SpecialRequest>();
        }
