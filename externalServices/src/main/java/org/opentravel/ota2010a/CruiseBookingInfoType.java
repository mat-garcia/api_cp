    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        protected List<CruiseBookingInfoType.BookingPrices.BookingPrice> bookingPrice = new Vector<CruiseBookingInfoType.BookingPrices.BookingPrice>();
        ...
        public List<CruiseBookingInfoType.BookingPrices.BookingPrice> getBookingPrice() {
            if (bookingPrice == null) {
                bookingPrice = new Vector<CruiseBookingInfoType.BookingPrices.BookingPrice>();
            }
        ...
        implements Serializable
    {
        ...
        protected List<CruiseBookingInfoType.GuestPrices.GuestPrice> guestPrice = new Vector<CruiseBookingInfoType.GuestPrices.GuestPrice>();
        ...
        public List<CruiseBookingInfoType.GuestPrices.GuestPrice> getGuestPrice() {
            if (guestPrice == null) {
                guestPrice = new Vector<CruiseBookingInfoType.GuestPrices.GuestPrice>();
            }
            ...
            implements Serializable
        {
                ...
                implements Serializable
            {
                ...
                protected List<CruiseBookingInfoType.GuestPrices.GuestPrice.PriceInfos.PriceInfo> priceInfo = new Vector<CruiseBookingInfoType.GuestPrices.GuestPrice.PriceInfos.PriceInfo>();
                ...
                public List<CruiseBookingInfoType.GuestPrices.GuestPrice.PriceInfos.PriceInfo> getPriceInfo() {
                    if (priceInfo == null) {
                        priceInfo = new Vector<CruiseBookingInfoType.GuestPrices.GuestPrice.PriceInfos.PriceInfo>();
                    }
        ...
        implements Serializable
    {
        ...
        protected List<CruiseBookingInfoType.PaymentSchedule.Payment> payment = new Vector<CruiseBookingInfoType.PaymentSchedule.Payment>();
        ...
        public List<CruiseBookingInfoType.PaymentSchedule.Payment> getPayment() {
            if (payment == null) {
                payment = new Vector<CruiseBookingInfoType.PaymentSchedule.Payment>();
            }
            return this.payment;
        }
