...
@XmlSeeAlso({
    org.opentravel.ota2010a.TravelerInfoSummaryType.PriceRequestInformation.class
})
    ...
    implements Serializable
{
    ...
    protected List<PriceRequestInformationType.NegotiatedFareCode> negotiatedFareCode = new Vector<PriceRequestInformationType.NegotiatedFareCode>();
    @XmlElement(name = "RebookOption")
    protected List<PriceRequestInformationType.RebookOption> rebookOption = new Vector<PriceRequestInformationType.RebookOption>();
    ...
    public List<PriceRequestInformationType.NegotiatedFareCode> getNegotiatedFareCode() {
        if (negotiatedFareCode == null) {
            negotiatedFareCode = new Vector<PriceRequestInformationType.NegotiatedFareCode>();
        }
    ...
    public List<PriceRequestInformationType.RebookOption> getRebookOption() {
        if (rebookOption == null) {
            rebookOption = new Vector<PriceRequestInformationType.RebookOption>();
        }
