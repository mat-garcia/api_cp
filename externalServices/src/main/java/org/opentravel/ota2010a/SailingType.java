...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_CruiseSailAvailRS.SailingOptions.SailingOption.class
})
    ...
    implements Serializable
{
    ...
    protected List<SailingType.Dining> dining = new Vector<SailingType.Dining>();
    @XmlElement(name = "Transportation")
    protected List<GuestTransportationType> transportation = new Vector<GuestTransportationType>();
    ...
    public List<SailingType.Dining> getDining() {
        if (dining == null) {
            dining = new Vector<SailingType.Dining>();
        }
        return this.dining;
    }
    ...
    public List<GuestTransportationType> getTransportation() {
        if (transportation == null) {
            transportation = new Vector<GuestTransportationType>();
        }
