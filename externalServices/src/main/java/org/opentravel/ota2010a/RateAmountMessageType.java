...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_NotifReportRQ.NotifDetails.HotelNotifReport.RateAmountMessages.RateAmountMessage.class
})
    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        protected List<RateAmountMessageType.Rates.Rate> rate = new Vector<RateAmountMessageType.Rates.Rate>();
        ...
        public List<RateAmountMessageType.Rates.Rate> getRate() {
            if (rate == null) {
                rate = new Vector<RateAmountMessageType.Rates.Rate>();
            }
            return this.rate;
        }
