...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_AirDemandTicketRQ.DemandTicketDetail.PaymentInfo.CreditCardInfo.class
})
    ...
    implements Serializable
{
    ...
    protected List<PaymentCardType.Telephone> telephone = new Vector<PaymentCardType.Telephone>();
    @XmlElement(name = "Email")
    protected List<EmailType> email = new Vector<EmailType>();
    @XmlElement(name = "CustLoyalty")
    protected List<PaymentCardType.CustLoyalty> custLoyalty = new Vector<PaymentCardType.CustLoyalty>();
    ...
    public List<PaymentCardType.Telephone> getTelephone() {
        if (telephone == null) {
            telephone = new Vector<PaymentCardType.Telephone>();
        }
    ...
    public List<PaymentCardType.CustLoyalty> getCustLoyalty() {
        if (custLoyalty == null) {
            custLoyalty = new Vector<PaymentCardType.CustLoyalty>();
        }
