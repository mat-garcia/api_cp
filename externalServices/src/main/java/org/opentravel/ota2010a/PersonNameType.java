...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_AirDemandTicketRQ.DemandTicketDetail.PassengerName.class,
    org.opentravel.ota2010a.OTA_AirDemandTicketRS.TicketItemInfo.PassengerName.class,
    org.opentravel.ota2010a.OTA_LoyaltyCertificateCreateRQ.Customer.class,
    org.opentravel.ota2010a.OTA_LoyaltyCertificateCreateRS.Customer.class,
    org.opentravel.ota2010a.OrganizationType.OrgMemberName.class,
    org.opentravel.ota2010a.TravelClubType.ClubMemberName.class,
    org.opentravel.ota2010a.VerificationType.PersonName.class,
    org.opentravel.ota2010a.ContactsType.Name.class,
    org.opentravel.ota2010a.CoveredTravelerType.CoveredPerson.class,
    org.opentravel.ota2010a.CoveredTravelerType.Beneficiary.Name.class
})
    ...
    implements Serializable
{
    ...
    protected List<String> namePrefix = new Vector<String>();
    @XmlElement(name = "GivenName")
    protected List<String> givenName = new Vector<String>();
    @XmlElement(name = "MiddleName")
    protected List<String> middleName = new Vector<String>();
    @XmlElement(name = "SurnamePrefix")
    protected String surnamePrefix;
    @XmlElement(name = "Surname", required = true)
    protected String surname;
    @XmlElement(name = "NameSuffix")
    protected List<String> nameSuffix = new Vector<String>();
    @XmlElement(name = "NameTitle")
    protected List<String> nameTitle = new Vector<String>();
