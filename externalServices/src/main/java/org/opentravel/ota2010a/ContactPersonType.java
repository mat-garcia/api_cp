...
@XmlSeeAlso({
    org.opentravel.ota2010a.AirCheckInType.PassengerInfo.ContactInfo.class,
    org.opentravel.ota2010a.EventType.Event.Contacts.Contact.class,
    org.opentravel.ota2010a.EventType.Event.EventInfos.EventInfo.Contacts.Contact.class,
    org.opentravel.ota2010a.EventType.Event.Sites.Site.EventDays.EventDay.EventDayFunctions.EventDayFunction.Contacts.Contact.class,
    org.opentravel.ota2010a.RFP_ResponseType.RFP_ResponseSegments.RFP_ResponseSegment.Sites.Site.References.Reference.class,
    org.opentravel.ota2010a.RecipientInfosType.RecipientInfo.class,
    org.opentravel.ota2010a.OTA_PurchaseItemRQ.PurchaserInfo.class,
    org.opentravel.ota2010a.CruiseGuestDetailType.ContactInfo.class,
    org.opentravel.ota2010a.HotelRoomListType.Guests.Guest.class,
    org.opentravel.ota2010a.HotelRoomListType.MasterContact.class,
    org.opentravel.ota2010a.EventReportType.GeneralEventInfo.EventContacts.EventContact.class,
    org.opentravel.ota2010a.PostEventSiteReportType.Contacts.Contact.class,
    org.opentravel.ota2010a.PostEventSiteReportType.EventDays.EventDay.EventDayFunctions.EventDayFunction.Contacts.Contact.class
})
    ...
    implements Serializable
{
    ...
    protected List<ContactPersonType.Telephone> telephone = new Vector<ContactPersonType.Telephone>();
    ...
    @XmlElement(name = "URL")
    protected List<URL_Type> url = new Vector<URL_Type>();
    @XmlElement(name = "CompanyName")
    protected List<CompanyNameType> companyName = new Vector<CompanyNameType>();
    ...
    public List<ContactPersonType.Telephone> getTelephone() {
        if (telephone == null) {
            telephone = new Vector<ContactPersonType.Telephone>();
        }
    ...
    public List<CompanyNameType> getCompanyName() {
        if (companyName == null) {
            companyName = new Vector<CompanyNameType>();
        }
