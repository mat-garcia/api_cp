...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_VehLocDetailsNotifRQ.LocationDetails.LocationDetail.AgeRequirements.class
})
    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        protected List<VehicleAgeRequirementsType.Age.AgeSurcharge> ageSurcharge = new Vector<VehicleAgeRequirementsType.Age.AgeSurcharge>();
        ...
        public List<VehicleAgeRequirementsType.Age.AgeSurcharge> getAgeSurcharge() {
            if (ageSurcharge == null) {
                ageSurcharge = new Vector<VehicleAgeRequirementsType.Age.AgeSurcharge>();
            }
            ...
            implements Serializable
        {
            ...
            protected List<VehicleAgeRequirementsType.Age.AgeInfos.AgeInfo> ageInfo = new Vector<VehicleAgeRequirementsType.Age.AgeInfos.AgeInfo>();
            ...
            public List<VehicleAgeRequirementsType.Age.AgeInfos.AgeInfo> getAgeInfo() {
                if (ageInfo == null) {
                    ageInfo = new Vector<VehicleAgeRequirementsType.Age.AgeInfos.AgeInfo>();
                }
                return this.ageInfo;
            }
            ...
            implements Serializable
        {
            ...
            protected List<VehicleAgeRequirementsType.Age.Vehicles.Vehicle> vehicle = new Vector<VehicleAgeRequirementsType.Age.Vehicles.Vehicle>();
            ...
            public List<VehicleAgeRequirementsType.Age.Vehicles.Vehicle> getVehicle() {
                if (vehicle == null) {
                    vehicle = new Vector<VehicleAgeRequirementsType.Age.Vehicles.Vehicle>();
                }
                return this.vehicle;
            }
