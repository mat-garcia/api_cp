...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_DynamicPkgAvailRS.SearchResults.HotelResults.RoomStays.RoomStay.class,
    org.opentravel.ota2010a.OTA_HotelAvailRS.RoomStays.RoomStay.class,
    org.opentravel.ota2010a.HotelRoomListType.RoomStays.RoomStay.class,
    org.opentravel.ota2010a.RoomStaysType.RoomStay.class
})
    ...
    implements Serializable
{
    ...
    protected List<GuaranteeType> guarantee = new Vector<GuaranteeType>();
    ...
    public List<GuaranteeType> getGuarantee() {
        if (guarantee == null) {
            guarantee = new Vector<GuaranteeType>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<RatePlanType> ratePlan = new Vector<RatePlanType>();
        ...
        public List<RatePlanType> getRatePlan() {
            if (ratePlan == null) {
                ratePlan = new Vector<RatePlanType>();
            }
        ...
        implements Serializable
    {
        ...
        protected List<RoomStayType.RoomRates.RoomRate> roomRate = new Vector<RoomStayType.RoomRates.RoomRate>();
        @XmlElement(name = "TPA_Extensions")
        protected TPA_ExtensionsType tpa_Extensions;
        ...
        public List<RoomStayType.RoomRates.RoomRate> getRoomRate() {
            if (roomRate == null) {
                roomRate = new Vector<RoomStayType.RoomRates.RoomRate>();
            }
            ...
            implements Serializable
        {
                ...
                implements Serializable
            {
                ...
                protected List<RoomStayType.RoomRates.RoomRate.GuestCounts.GuestCount> guestCount = new Vector<RoomStayType.RoomRates.RoomRate.GuestCounts.GuestCount>();
                ...
                public List<RoomStayType.RoomRates.RoomRate.GuestCounts.GuestCount> getGuestCount() {
                    if (guestCount == null) {
                        guestCount = new Vector<RoomStayType.RoomRates.RoomRate.GuestCounts.GuestCount>();
                    }
                ...
                implements Serializable
            {
                ...
                protected List<RoomStayType.RoomRates.RoomRate.Restrictions.Restriction> restriction = new Vector<RoomStayType.RoomRates.RoomRate.Restrictions.Restriction>();
                ...
                public List<RoomStayType.RoomRates.RoomRate.Restrictions.Restriction> getRestriction() {
                    if (restriction == null) {
                        restriction = new Vector<RoomStayType.RoomRates.RoomRate.Restrictions.Restriction>();
                    }
        ...
        implements Serializable
    {
        ...
        protected List<RoomTypeType> roomType = new Vector<RoomTypeType>();
        ...
        public List<RoomTypeType> getRoomType() {
            if (roomType == null) {
                roomType = new Vector<RoomTypeType>();
            }
