...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_CruiseDiningAvailRQ.DiningRoom.class,
    org.opentravel.ota2010a.OTA_CruiseDiningAvailRS.DiningOptions.DiningOption.DiningRoom.class,
    org.opentravel.ota2010a.RestaurantsType.Restaurant.class
})
    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        protected List<RestaurantType.CuisineCodes.CuisineCode> cuisineCode = new Vector<RestaurantType.CuisineCodes.CuisineCode>();
        ...
        public List<RestaurantType.CuisineCodes.CuisineCode> getCuisineCode() {
            if (cuisineCode == null) {
                cuisineCode = new Vector<RestaurantType.CuisineCodes.CuisineCode>();
            }
        ...
        implements Serializable
    {
        ...
        protected List<RestaurantType.InfoCodes.InfoCode> infoCode = new Vector<RestaurantType.InfoCodes.InfoCode>();
        ...
        public List<RestaurantType.InfoCodes.InfoCode> getInfoCode() {
            if (infoCode == null) {
                infoCode = new Vector<RestaurantType.InfoCodes.InfoCode>();
            }
