    ...
    implements Serializable
{
    ...
    protected List<TravelerInfoType.AirTraveler> airTraveler = new Vector<TravelerInfoType.AirTraveler>();
    @XmlElement(name = "SpecialReqDetails")
    protected List<SpecialReqDetailsType> specialReqDetails = new Vector<SpecialReqDetailsType>();
    ...
    public List<TravelerInfoType.AirTraveler> getAirTraveler() {
        if (airTraveler == null) {
            airTraveler = new Vector<TravelerInfoType.AirTraveler>();
        }
    ...
    public List<SpecialReqDetailsType> getSpecialReqDetails() {
        if (specialReqDetails == null) {
            specialReqDetails = new Vector<SpecialReqDetailsType>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<TravelerInfoType.AirTraveler.Comment> comment = new Vector<TravelerInfoType.AirTraveler.Comment>();
        ...
        public List<TravelerInfoType.AirTraveler.Comment> getComment() {
            if (comment == null) {
                comment = new Vector<TravelerInfoType.AirTraveler.Comment>();
            }
            return this.comment;
        }
