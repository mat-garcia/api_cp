    ...
    implements Serializable
{
    ...
    protected List<ProfileType.UserID> userID = new Vector<ProfileType.UserID>();
    ...
    protected List<String> statusCode = new Vector<String>();
    ...
    public List<ProfileType.UserID> getUserID() {
        if (userID == null) {
            userID = new Vector<ProfileType.UserID>();
        }
        return this.userID;
    }
        ...
        implements Serializable
    {
        ...
        protected List<ProfileType.Comments.Comment> comment = new Vector<ProfileType.Comments.Comment>();
        ...
        public List<ProfileType.Comments.Comment> getComment() {
            if (comment == null) {
                comment = new Vector<ProfileType.Comments.Comment>();
            }
            return this.comment;
        }
            ...
            implements Serializable
        {
            ...
            protected List<ProfileType.Comments.Comment.AuthorizedViewer> authorizedViewer = new Vector<ProfileType.Comments.Comment.AuthorizedViewer>();
            ...
            public List<ProfileType.Comments.Comment.AuthorizedViewer> getAuthorizedViewer() {
                if (authorizedViewer == null) {
                    authorizedViewer = new Vector<ProfileType.Comments.Comment.AuthorizedViewer>();
                }
