    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        protected List<HotelRatePlanType.DestinationSystemsCode.DestinationSystemCode> destinationSystemCode = new Vector<HotelRatePlanType.DestinationSystemsCode.DestinationSystemCode>();
        ...
        public List<HotelRatePlanType.DestinationSystemsCode.DestinationSystemCode> getDestinationSystemCode() {
            if (destinationSystemCode == null) {
                destinationSystemCode = new Vector<HotelRatePlanType.DestinationSystemsCode.DestinationSystemCode>();
            }
            ...
            implements Serializable
        {
            ...
            /**
             * Gets the value of the pos_RuleID property.
             * 
             * @return
             *     possible object is
             *     {@link String }
             *     
             */
            public String getPOS_RuleID() {
                return pos_RuleID;
            }

            /**
             * Sets the value of the pos_RuleID property.
             * 
             * @param value
             *     allowed object is
             *     {@link String }
             *     
             */
            public void setPOS_RuleID(String value) {
                this.pos_RuleID = value;
            }
        ...
        implements Serializable
    {
        ...
        protected List<HotelRatePlanType.Offers.Offer> offer = new Vector<HotelRatePlanType.Offers.Offer>();
        ...
        public List<HotelRatePlanType.Offers.Offer> getOffer() {
            if (offer == null) {
                offer = new Vector<HotelRatePlanType.Offers.Offer>();
            }
            return this.offer;
        }
            ...
            implements Serializable
        {
            ...
            protected List<String> supplementRPH = new Vector<String>();
            ...
            public List<String> getSupplementRPH() {
                if (supplementRPH == null) {
                    supplementRPH = new Vector<String>();
                }
        ...
        implements Serializable
    {
        ...
        protected List<HotelRatePlanType.RatePlanLevelFee.Fee> fee = new Vector<HotelRatePlanType.RatePlanLevelFee.Fee>();
        ...
        public List<HotelRatePlanType.RatePlanLevelFee.Fee> getFee() {
            if (fee == null) {
                fee = new Vector<HotelRatePlanType.RatePlanLevelFee.Fee>();
            }
            return this.fee;
        }
        ...
        implements Serializable
    {
        ...
        protected List<HotelRatePlanType.RatePlanShoulders.RatePlanShoulder> ratePlanShoulder = new Vector<HotelRatePlanType.RatePlanShoulders.RatePlanShoulder>();
        ...
        public List<HotelRatePlanType.RatePlanShoulders.RatePlanShoulder> getRatePlanShoulder() {
            if (ratePlanShoulder == null) {
                ratePlanShoulder = new Vector<HotelRatePlanType.RatePlanShoulders.RatePlanShoulder>();
            }
        ...
        implements Serializable
    {
        ...
        protected List<HotelRatePlanType.Rates.Rate> rate = new Vector<HotelRatePlanType.Rates.Rate>();
        ...
        public List<HotelRatePlanType.Rates.Rate> getRate() {
            if (rate == null) {
                rate = new Vector<HotelRatePlanType.Rates.Rate>();
            }
            return this.rate;
        }
        ...
        implements Serializable
    {
        ...
        protected List<HotelRatePlanType.Supplements.Supplement> supplement = new Vector<HotelRatePlanType.Supplements.Supplement>();
        ...
        public List<HotelRatePlanType.Supplements.Supplement> getSupplement() {
            if (supplement == null) {
                supplement = new Vector<HotelRatePlanType.Supplements.Supplement>();
            }
            ...
            implements Serializable
        {
            ...
            protected List<HotelRatePlanType.Supplements.Supplement.RoomCompanions> roomCompanions = new Vector<HotelRatePlanType.Supplements.Supplement.RoomCompanions>();
            @XmlElement(name = "PrerequisiteInventory")
            protected List<HotelRatePlanType.Supplements.Supplement.PrerequisiteInventory> prerequisiteInventory = new Vector<HotelRatePlanType.Supplements.Supplement.PrerequisiteInventory>();
            @XmlElement(name = "Description")
            protected List<ParagraphType> description = new Vector<ParagraphType>();
            ...
            public List<HotelRatePlanType.Supplements.Supplement.RoomCompanions> getRoomCompanions() {
                if (roomCompanions == null) {
                    roomCompanions = new Vector<HotelRatePlanType.Supplements.Supplement.RoomCompanions>();
                }
            ...
            public List<HotelRatePlanType.Supplements.Supplement.PrerequisiteInventory> getPrerequisiteInventory() {
                if (prerequisiteInventory == null) {
                    prerequisiteInventory = new Vector<HotelRatePlanType.Supplements.Supplement.PrerequisiteInventory>();
                }
