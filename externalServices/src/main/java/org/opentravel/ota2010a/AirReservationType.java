...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_AirBookModifyRQ.AirBookModifyRQ.class,
    org.opentravel.ota2010a.OTA_AirBookRS.AirReservation.class,
    org.opentravel.ota2010a.OTA_AirDisplayQueueRS.DisplayQueue.AirReservations.AirReservation.class
})
public class AirReservationType implements Serializable
{
    ...
    protected List<TicketingInfoType> ticketing = new Vector<TicketingInfoType>();
    @XmlElement(name = "Queues")
    protected AirReservationType.Queues queues;
    @XmlElement(name = "BookingReferenceID")
    protected List<AirReservationType.BookingReferenceID> bookingReferenceID = new Vector<AirReservationType.BookingReferenceID>();
    ...
    public List<TicketingInfoType> getTicketing() {
        if (ticketing == null) {
            ticketing = new Vector<TicketingInfoType>();
        }
    ...
    public List<AirReservationType.BookingReferenceID> getBookingReferenceID() {
        if (bookingReferenceID == null) {
            bookingReferenceID = new Vector<AirReservationType.BookingReferenceID>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<AirReservationType.PricingOverview.PricingIndicator> pricingIndicator = new Vector<AirReservationType.PricingOverview.PricingIndicator>();
        @XmlElement(name = "Account")
        protected List<AirReservationType.PricingOverview.Account> account = new Vector<AirReservationType.PricingOverview.Account>();
        @XmlElement(name = "Comment")
        ...
        public List<AirReservationType.PricingOverview.PricingIndicator> getPricingIndicator() {
            if (pricingIndicator == null) {
                pricingIndicator = new Vector<AirReservationType.PricingOverview.PricingIndicator>();
            }
        ...
        public List<AirReservationType.PricingOverview.Account> getAccount() {
            if (account == null) {
                account = new Vector<AirReservationType.PricingOverview.Account>();
            }
            return this.account;
        }
        ...
        implements Serializable
    {
        ...
        protected List<AirReservationType.Queues.Queue> queue = new Vector<AirReservationType.Queues.Queue>();
        ...
        public List<AirReservationType.Queues.Queue> getQueue() {
            if (queue == null) {
                queue = new Vector<AirReservationType.Queues.Queue>();
            }
            return this.queue;
        }
