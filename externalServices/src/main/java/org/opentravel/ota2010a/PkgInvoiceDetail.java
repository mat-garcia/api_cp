    ...
    implements Serializable
{
    ...
    protected List<PkgInvoiceDetail.AgentCommission> agentCommission = new Vector<PkgInvoiceDetail.AgentCommission>();
    ...
    public List<PkgInvoiceDetail.AgentCommission> getAgentCommission() {
        if (agentCommission == null) {
            agentCommission = new Vector<PkgInvoiceDetail.AgentCommission>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<CostingItemType> costingItem = new Vector<CostingItemType>();
        ...
        public List<CostingItemType> getCostingItem() {
            if (costingItem == null) {
                costingItem = new Vector<CostingItemType>();
            }
