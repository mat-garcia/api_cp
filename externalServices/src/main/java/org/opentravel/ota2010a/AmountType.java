...
@XmlSeeAlso({
    org.opentravel.ota2010a.RateType.Rate.class
})
    ...
    implements Serializable
{
    ...
    protected List<AmountType.Discount> discount = new Vector<AmountType.Discount>();
    ...
    public List<AmountType.Discount> getDiscount() {
        if (discount == null) {
            discount = new Vector<AmountType.Discount>();
        }
