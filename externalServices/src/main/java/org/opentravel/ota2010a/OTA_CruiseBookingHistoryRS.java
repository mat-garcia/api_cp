...
public class OTA_CruiseBookingHistoryRS
    implements Serializable
{
    ...
    protected OTA_CruiseBookingHistoryRS.ReservationID reservationID;
    @XmlElement(name = "SailingInfo")
    protected SailingCategoryInfoType sailingInfo;
    @XmlElement(name = "HistoryInfos")
    protected OTA_CruiseBookingHistoryRS.HistoryInfos historyInfos;
     ...
     * @return
     *     possible object is
     *     {@link OTA_CruiseBookingHistoryRS.ReservationID }
     *     
     */
    public OTA_CruiseBookingHistoryRS.ReservationID getReservationID() {
     ...
     *     
     */
    public void setReservationID(OTA_CruiseBookingHistoryRS.ReservationID value) {
     ...
     * @return
     *     possible object is
     *     {@link OTA_CruiseBookingHistoryRS.HistoryInfos }
     *     
     */
    public OTA_CruiseBookingHistoryRS.HistoryInfos getHistoryInfos() {
        return historyInfos;
    }
     ...
     *     
     */
    public void setHistoryInfos(OTA_CruiseBookingHistoryRS.HistoryInfos value) {
        ...
        implements Serializable
    {
        ...
        protected List<OTA_CruiseBookingHistoryRS.HistoryInfos.HistoryInfo> historyInfo = new Vector<OTA_CruiseBookingHistoryRS.HistoryInfos.HistoryInfo>();
         ...
         * {@link OTA_CruiseBookingHistoryRS.HistoryInfos.HistoryInfo }
         * 
         * 
         */
        public List<OTA_CruiseBookingHistoryRS.HistoryInfos.HistoryInfo> getHistoryInfo() {
            if (historyInfo == null) {
                historyInfo = new Vector<OTA_CruiseBookingHistoryRS.HistoryInfos.HistoryInfo>();
            }
            ...
            implements Serializable
        {
            ...
            protected List<OTA_CruiseBookingHistoryRS.HistoryInfos.HistoryInfo.Items> items = new Vector<OTA_CruiseBookingHistoryRS.HistoryInfos.HistoryInfo.Items>();
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link OTA_CruiseBookingHistoryRS.HistoryInfos.HistoryInfo.Items }
             * 
             * 
             */
            public List<OTA_CruiseBookingHistoryRS.HistoryInfos.HistoryInfo.Items> getItems() {
                if (items == null) {
                    items = new Vector<OTA_CruiseBookingHistoryRS.HistoryInfos.HistoryInfo.Items>();
                }
                return this.items;
            }
                ...
                implements Serializable
            {
                ...
                protected List<OTA_CruiseBookingHistoryRS.HistoryInfos.HistoryInfo.Items.Item> item = new Vector<OTA_CruiseBookingHistoryRS.HistoryInfos.HistoryInfo.Items.Item>();
                 ...
                 * <p>
                 * Objects of the following type(s) are allowed in the list
                 * {@link OTA_CruiseBookingHistoryRS.HistoryInfos.HistoryInfo.Items.Item }
                 * 
                 * 
                 */
                public List<OTA_CruiseBookingHistoryRS.HistoryInfos.HistoryInfo.Items.Item> getItem() {
                    if (item == null) {
                        item = new Vector<OTA_CruiseBookingHistoryRS.HistoryInfos.HistoryInfo.Items.Item>();
                    }
                    return this.item;
                }
