 ...
 *         &lt;/simpleType&gt;
 *       &lt;/attribute&gt;
 *       &lt;attribute name="Rate" type="{http://www.opentravel.org/OTA/2003/05}Percentage" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
    ...
    implements Serializable
{
    ...
    protected List<TaxItemType.TaxAmount> taxAmount = new Vector<TaxItemType.TaxAmount>();
     ...
     * {@link TaxItemType.TaxAmount }
     * 
     * 
     */
    public List<TaxItemType.TaxAmount> getTaxAmount() {
        if (taxAmount == null) {
            taxAmount = new Vector<TaxItemType.TaxAmount>();
        }
