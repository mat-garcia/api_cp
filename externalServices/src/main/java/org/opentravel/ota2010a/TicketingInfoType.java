...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_AirBookRQ.Ticketing.class,
    TicketingInfoRS_Type.class
})
    ...
    implements Serializable
{
    ...
    protected List<TicketingInfoType.TicketAdvisory> ticketAdvisory = new Vector<TicketingInfoType.TicketAdvisory>();
    ...
    protected List<String> flightSegmentRefNumber = new Vector<String>();
    @XmlAttribute(name = "TravelerRefNumber")
    protected List<String> travelerRefNumber = new Vector<String>();
    ...
    protected List<String> miscTicketingCode = new Vector<String>();
    ...
    public List<TicketingInfoType.TicketAdvisory> getTicketAdvisory() {
        if (ticketAdvisory == null) {
            ticketAdvisory = new Vector<TicketingInfoType.TicketAdvisory>();
        }
    ...
    public List<String> getFlightSegmentRefNumber() {
        if (flightSegmentRefNumber == null) {
            flightSegmentRefNumber = new Vector<String>();
        }
    ...
    public List<String> getTravelerRefNumber() {
        if (travelerRefNumber == null) {
            travelerRefNumber = new Vector<String>();
        }
    ...
    public List<String> getMiscTicketingCode() {
        if (miscTicketingCode == null) {
            miscTicketingCode = new Vector<String>();
        }
