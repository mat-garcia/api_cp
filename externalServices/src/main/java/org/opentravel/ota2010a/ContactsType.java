    ...
    implements Serializable
{
    ...
    protected List<ContactsType.Name> name = new Vector<ContactsType.Name>();
    ...
    public List<ContactsType.Name> getName() {
        if (name == null) {
            name = new Vector<ContactsType.Name>();
        }
        return this.name;
    }
        ...
        implements Serializable
    {
        ...
        protected List<ContactsType.Name.JobTitle> jobTitle = new Vector<ContactsType.Name.JobTitle>();
        ...
        public List<ContactsType.Name.JobTitle> getJobTitle() {
            if (jobTitle == null) {
                jobTitle = new Vector<ContactsType.Name.JobTitle>();
            }
