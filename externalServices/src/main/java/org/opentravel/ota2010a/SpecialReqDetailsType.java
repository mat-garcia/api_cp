...
@XmlSeeAlso({
    org.opentravel.ota2010a.AssociatedContentType.AssocItems.SpecialRequestDetails.class,
    org.opentravel.ota2010a.AssociatedContentType.SpecialRequestDetails.class,
    org.opentravel.ota2010a.ItineraryInfoType.SpecialRequestDetails.class,
    org.opentravel.ota2010a.ReservationItemsType.SpecialRequestDetails.class
})
    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        protected List<SpecialReqDetailsType.OtherServiceInformations.OtherServiceInformation> otherServiceInformation = new Vector<SpecialReqDetailsType.OtherServiceInformations.OtherServiceInformation>();
        ...
        public List<SpecialReqDetailsType.OtherServiceInformations.OtherServiceInformation> getOtherServiceInformation() {
            if (otherServiceInformation == null) {
                otherServiceInformation = new Vector<SpecialReqDetailsType.OtherServiceInformations.OtherServiceInformation>();
            }
        ...
        implements Serializable
    {
        ...
        protected List<SpecialReqDetailsType.Remarks.Remark> remark = new Vector<SpecialReqDetailsType.Remarks.Remark>();
        ...
        public List<SpecialReqDetailsType.Remarks.Remark> getRemark() {
            if (remark == null) {
                remark = new Vector<SpecialReqDetailsType.Remarks.Remark>();
            }
            return this.remark;
        }
        ...
        implements Serializable
    {
        ...
        protected List<SpecialReqDetailsType.SeatRequests.SeatRequest> seatRequest = new Vector<SpecialReqDetailsType.SeatRequests.SeatRequest>();
        ...
        public List<SpecialReqDetailsType.SeatRequests.SeatRequest> getSeatRequest() {
            if (seatRequest == null) {
                seatRequest = new Vector<SpecialReqDetailsType.SeatRequests.SeatRequest>();
            }
        ...
        implements Serializable
    {
        ...
        protected List<SpecialReqDetailsType.SpecialRemarks.SpecialRemark> specialRemark = new Vector<SpecialReqDetailsType.SpecialRemarks.SpecialRemark>();
        ...
        public List<SpecialReqDetailsType.SpecialRemarks.SpecialRemark> getSpecialRemark() {
            if (specialRemark == null) {
                specialRemark = new Vector<SpecialReqDetailsType.SpecialRemarks.SpecialRemark>();
            }
        ...
        implements Serializable
    {
        ...
        protected List<SpecialReqDetailsType.SpecialServiceRequests.SpecialServiceRequest> specialServiceRequest = new Vector<SpecialReqDetailsType.SpecialServiceRequests.SpecialServiceRequest>();
        ...
        public List<SpecialReqDetailsType.SpecialServiceRequests.SpecialServiceRequest> getSpecialServiceRequest() {
            if (specialServiceRequest == null) {
                specialServiceRequest = new Vector<SpecialReqDetailsType.SpecialServiceRequests.SpecialServiceRequest>();
            }
