    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        protected List<PostEventSiteReportType> eventSite = new Vector<PostEventSiteReportType>();
        ...
        public List<PostEventSiteReportType> getEventSite() {
            if (eventSite == null) {
                eventSite = new Vector<PostEventSiteReportType>();
            }
        ...
        implements Serializable
    {
        ...
        protected List<EventReportType.GeneralEventInfo.AttendeeInfo> attendeeInfo = new Vector<EventReportType.GeneralEventInfo.AttendeeInfo>();
        ...
        protected List<String> destinationServiceProviderCode = new Vector<String>();
        ...
        protected List<String> eventReportRPH = new Vector<String>();
        ...
        public List<EventReportType.GeneralEventInfo.AttendeeInfo> getAttendeeInfo() {
            if (attendeeInfo == null) {
                attendeeInfo = new Vector<EventReportType.GeneralEventInfo.AttendeeInfo>();
            }
        ...
        public List<String> getDestinationServiceProviderCode() {
            if (destinationServiceProviderCode == null) {
                destinationServiceProviderCode = new Vector<String>();
            }
        ...
        public List<String> getEventReportRPH() {
            if (eventReportRPH == null) {
                eventReportRPH = new Vector<String>();
            }
            ...
            implements Serializable
        {
            ...
            protected List<EventReportType.GeneralEventInfo.Dates.Date> date = new Vector<EventReportType.GeneralEventInfo.Dates.Date>();
            ...
            public List<EventReportType.GeneralEventInfo.Dates.Date> getDate() {
                if (date == null) {
                    date = new Vector<EventReportType.GeneralEventInfo.Dates.Date>();
                }
                return this.date;
            }
                ...
                implements Serializable
            {
                ...
                protected List<EventReportType.GeneralEventInfo.Dates.Date.LocationCategories> locationCategories = new Vector<EventReportType.GeneralEventInfo.Dates.Date.LocationCategories>();
                @XmlElement(name = "Comments")
                ...
                public List<EventReportType.GeneralEventInfo.Dates.Date.LocationCategories> getLocationCategories() {
                    if (locationCategories == null) {
                        locationCategories = new Vector<EventReportType.GeneralEventInfo.Dates.Date.LocationCategories>();
                    }
                    ...
                    implements Serializable
                {
                    ...
                    protected List<EventReportType.GeneralEventInfo.Dates.Date.LocationCategories.Category> category = new Vector<EventReportType.GeneralEventInfo.Dates.Date.LocationCategories.Category>();
                    ...
                    public List<EventReportType.GeneralEventInfo.Dates.Date.LocationCategories.Category> getCategory() {
                        if (category == null) {
                            category = new Vector<EventReportType.GeneralEventInfo.Dates.Date.LocationCategories.Category>();
                        }
            ...
            implements Serializable
        {
            ...
            protected List<EventReportType.GeneralEventInfo.EventContacts.EventContact> eventContact = new Vector<EventReportType.GeneralEventInfo.EventContacts.EventContact>();
            ...
            public List<EventReportType.GeneralEventInfo.EventContacts.EventContact> getEventContact() {
                if (eventContact == null) {
                    eventContact = new Vector<EventReportType.GeneralEventInfo.EventContacts.EventContact>();
                }
            ...
            implements Serializable
        {
            ...
            protected List<String> propertyTypeCode = new Vector<String>();
            ...
            public List<String> getPropertyTypeCode() {
                if (propertyTypeCode == null) {
                    propertyTypeCode = new Vector<String>();
                }
            ...
            implements Serializable
        {
            ...
            protected Boolean icw_Indicator;
            ...
            /**
             * Gets the value of the icw_Indicator property.
             * 
             * @return
             *     possible object is
             *     {@link Boolean }
             *     
             */
            public Boolean isICW_Indicator() {
                return icw_Indicator;
            }

            /**
             * Sets the value of the icw_Indicator property.
             * 
             * @param value
             *     allowed object is
             *     {@link Boolean }
             *     
             */
            public void setICW_Indicator(Boolean value) {
                this.icw_Indicator = value;
            }
            ...
            implements Serializable
        {
            ...
            protected List<EventReportType.GeneralEventInfo.FunctionSpaceInfo.FunctionSpaceRequirements> functionSpaceRequirements = new Vector<EventReportType.GeneralEventInfo.FunctionSpaceInfo.FunctionSpaceRequirements>();
            @XmlElement(name = "Comments")
            ...
            protected List<String> utilityCode = new Vector<String>();
            @XmlAttribute(name = "TelecommunicationCode")
            protected List<String> telecommunicationCode = new Vector<String>();
            ...
            public List<EventReportType.GeneralEventInfo.FunctionSpaceInfo.FunctionSpaceRequirements> getFunctionSpaceRequirements() {
                if (functionSpaceRequirements == null) {
                    functionSpaceRequirements = new Vector<EventReportType.GeneralEventInfo.FunctionSpaceInfo.FunctionSpaceRequirements>();
                }
            ...
            public List<String> getTelecommunicationCode() {
                if (telecommunicationCode == null) {
                    telecommunicationCode = new Vector<String>();
                }
                ...
                implements Serializable
            {
                ...
                protected List<String> audioVisualCode = new Vector<String>();
                ...
                public List<String> getAudioVisualCode() {
                    if (audioVisualCode == null) {
                        audioVisualCode = new Vector<String>();
                    }
