...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_VehRateNotifRQ.Rates.Rate.class,
    org.opentravel.ota2010a.OTA_VehRateRuleRS.RentalRate.class
})
    ...
    implements Serializable
{
    ...
    protected List<VehicleRentalRateType.RateDistance> rateDistance = new Vector<VehicleRentalRateType.RateDistance>();
    ...
    protected List<VehicleRentalRateType.PickupReturnRule> pickupReturnRule = new Vector<VehicleRentalRateType.PickupReturnRule>();
    ...
    public List<VehicleRentalRateType.RateDistance> getRateDistance() {
        if (rateDistance == null) {
            rateDistance = new Vector<VehicleRentalRateType.RateDistance>();
        }
    ...
    public List<VehicleRentalRateType.PickupReturnRule> getPickupReturnRule() {
        if (pickupReturnRule == null) {
            pickupReturnRule = new Vector<VehicleRentalRateType.PickupReturnRule>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<String> custLoyaltyRPH = new Vector<String>();
        @XmlAttribute(name = "QuoteID")
        protected String quoteID;
        ...
        public List<String> getCustLoyaltyRPH() {
            if (custLoyaltyRPH == null) {
                custLoyaltyRPH = new Vector<String>();
            }
