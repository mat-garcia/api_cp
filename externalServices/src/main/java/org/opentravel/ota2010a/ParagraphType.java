...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_CruiseBookingHistoryRS.HistoryInfos.HistoryInfo.Items.Item.class,
    org.opentravel.ota2010a.OTA_HotelRFP_TransientRQ.TransientRFP_RequestSegments.RequestedInfos.RequestedInfo.SpecificRequests.SpecificRequest.class,
    org.opentravel.ota2010a.OTA_HotelRFP_TransientRQ.TransientRFP_RequestSegments.Comments.Comment.class,
    org.opentravel.ota2010a.ProfileType.Comments.Comment.class,
    org.opentravel.ota2010a.OTA_VehLocDetailsNotifRQ.LocationDetails.LocationDetail.Policies.Policy.class,
    org.opentravel.ota2010a.OTA_VehLocDetailsNotifRQ.LocationDetails.LocationDetail.Keywords.Keyword.class,
    org.opentravel.ota2010a.CommentType.Comment.class,
    org.opentravel.ota2010a.SpecialRequestType.SpecialRequest.class,
    org.opentravel.ota2010a.InvBlockType.BlockDescriptions.BlockDescription.class,
    org.opentravel.ota2010a.AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramDescription.class,
    org.opentravel.ota2010a.AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramRestriction.class,
    ...
    implements Serializable
{
    ...
    protected List<JAXBElement<? extends Serializable>> textOrImageOrURL = new Vector<JAXBElement<? extends Serializable>>();
     ...
     * 
     */
    public List<JAXBElement<? extends Serializable>> getTextOrImageOrURL() {
        if (textOrImageOrURL == null) {
            textOrImageOrURL = new Vector<JAXBElement<? extends Serializable>>();
        }
