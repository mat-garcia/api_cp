...
@XmlSeeAlso({
    org.opentravel.ota2010a.AirCheckInType.PassengerFlightInfo.API_Info.Address.class,
    org.opentravel.ota2010a.AirTravelerType.Address.class,
    org.opentravel.ota2010a.OffLocationServiceCoreType.Address.class,
    org.opentravel.ota2010a.ItemSearchCriterionType.Address.class,
    AddressInfoType.class,
    org.opentravel.ota2010a.TripFeaturesType.Destinations.Destination.class
})
    ...
    implements Serializable
{
    ...
    protected List<AddressType.BldgRoom> bldgRoom = new Vector<AddressType.BldgRoom>();
    @XmlElement(name = "AddressLine")
    protected List<String> addressLine = new Vector<String>();
    ...
    public List<AddressType.BldgRoom> getBldgRoom() {
        if (bldgRoom == null) {
            bldgRoom = new Vector<AddressType.BldgRoom>();
        }
