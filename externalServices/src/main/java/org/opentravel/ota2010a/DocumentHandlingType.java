...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_CruiseBookingDocumentRQ.CruiseDocument.class,
    org.opentravel.ota2010a.OTA_CruiseBookingDocumentRS.CruiseDocument.class
})
    ...
    implements Serializable
{
    ...
    protected List<DocumentHandlingType.VendorOption> vendorOption = new Vector<DocumentHandlingType.VendorOption>();
    ...
    public List<DocumentHandlingType.VendorOption> getVendorOption() {
        if (vendorOption == null) {
            vendorOption = new Vector<DocumentHandlingType.VendorOption>();
        }
