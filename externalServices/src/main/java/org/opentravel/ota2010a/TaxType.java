...
@XmlSeeAlso({
    org.opentravel.ota2010a.PoliciesType.Policy.TaxPolicies.TaxPolicy.class
})
    ...
    implements Serializable
{
    ...
    protected List<ParagraphType> taxDescription = new Vector<ParagraphType>();
    ...
    public List<ParagraphType> getTaxDescription() {
        if (taxDescription == null) {
            taxDescription = new Vector<ParagraphType>();
        }
