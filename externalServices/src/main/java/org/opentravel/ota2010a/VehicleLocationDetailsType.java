...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_VehExchangeRS.ExchangeLocationDetails.class,
    org.opentravel.ota2010a.OTA_VehRateRuleRS.LocationDetails.class
})
    ...
    implements Serializable
{
    ...
    protected List<VehicleLocationDetailsType.Telephone> telephone = new Vector<VehicleLocationDetailsType.Telephone>();
    ...
    public List<VehicleLocationDetailsType.Telephone> getTelephone() {
        if (telephone == null) {
            telephone = new Vector<VehicleLocationDetailsType.Telephone>();
        }
