    ...
    implements Serializable
{
    ...
    protected List<PkgPassengerRPHs.PassengerRPH> passengerRPH = new Vector<PkgPassengerRPHs.PassengerRPH>();
    ...
    public List<PkgPassengerRPHs.PassengerRPH> getPassengerRPH() {
        if (passengerRPH == null) {
            passengerRPH = new Vector<PkgPassengerRPHs.PassengerRPH>();
        }
