...
@XmlSeeAlso({
    org.opentravel.ota2010a.AreaInfoType.RefPoints.class
})
    ...
    implements Serializable
{
    ...
    protected List<RefPointsType.RefPoint> refPoint = new Vector<RefPointsType.RefPoint>();
    ...
    public List<RefPointsType.RefPoint> getRefPoint() {
        if (refPoint == null) {
            refPoint = new Vector<RefPointsType.RefPoint>();
        }
