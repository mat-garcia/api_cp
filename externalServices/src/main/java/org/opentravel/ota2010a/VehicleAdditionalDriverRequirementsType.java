...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_VehLocDetailsNotifRQ.LocationDetails.LocationDetail.AdditionalDriverRequirements.class
})
    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        protected List<VehicleAdditionalDriverRequirementsType.AddlDriverInfos.AddlDriverInfo> addlDriverInfo = new Vector<VehicleAdditionalDriverRequirementsType.AddlDriverInfos.AddlDriverInfo>();
        ...
        public List<VehicleAdditionalDriverRequirementsType.AddlDriverInfos.AddlDriverInfo> getAddlDriverInfo() {
            if (addlDriverInfo == null) {
                addlDriverInfo = new Vector<VehicleAdditionalDriverRequirementsType.AddlDriverInfos.AddlDriverInfo>();
            }
            ...
            implements Serializable
        {
            ...
            protected List<VehicleAdditionalDriverRequirementsType.AddlDriverInfos.Vehicles.Vehicle> vehicle = new Vector<VehicleAdditionalDriverRequirementsType.AddlDriverInfos.Vehicles.Vehicle>();
            ...
            public List<VehicleAdditionalDriverRequirementsType.AddlDriverInfos.Vehicles.Vehicle> getVehicle() {
                if (vehicle == null) {
                    vehicle = new Vector<VehicleAdditionalDriverRequirementsType.AddlDriverInfos.Vehicles.Vehicle>();
                }
                return this.vehicle;
            }
