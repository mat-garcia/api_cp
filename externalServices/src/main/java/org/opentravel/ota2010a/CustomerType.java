...
@XmlSeeAlso({
    org.opentravel.ota2010a.CustomerPrimaryAdditionalType.Primary.class,
    org.opentravel.ota2010a.CustomerPrimaryAdditionalType.Additional.class,
    ...
    implements Serializable
{
    ...
    protected List<PersonNameType> personName = new Vector<PersonNameType>();
    @XmlElement(name = "Telephone")
    protected List<CustomerType.Telephone> telephone = new Vector<CustomerType.Telephone>();
    @XmlElement(name = "Email")
    protected List<CustomerType.Email> email = new Vector<CustomerType.Email>();
    @XmlElement(name = "Address")
    protected List<CustomerType.Address> address = new Vector<CustomerType.Address>();
    @XmlElement(name = "URL")
    protected List<CustomerType.URL> url = new Vector<CustomerType.URL>();
    @XmlElement(name = "CitizenCountryName")
    protected List<CustomerType.CitizenCountryName> citizenCountryName = new Vector<CustomerType.CitizenCountryName>();
    @XmlElement(name = "PhysChallName")
    protected List<CustomerType.PhysChallName> physChallName = new Vector<CustomerType.PhysChallName>();
    @XmlElement(name = "PetInfo")
    protected List<String> petInfo = new Vector<String>();
    @XmlElement(name = "PaymentForm")
    protected List<CustomerType.PaymentForm> paymentForm = new Vector<CustomerType.PaymentForm>();
    @XmlElement(name = "RelatedTraveler")
    protected List<RelatedTravelerType> relatedTraveler = new Vector<RelatedTravelerType>();
    @XmlElement(name = "ContactPerson")
    protected List<ContactPersonType> contactPerson = new Vector<ContactPersonType>();
    @XmlElement(name = "Document")
    protected List<DocumentType> document = new Vector<DocumentType>();
    @XmlElement(name = "CustLoyalty")
    protected List<CustomerType.CustLoyalty> custLoyalty = new Vector<CustomerType.CustLoyalty>();
    @XmlElement(name = "EmployeeInfo")
    protected List<EmployeeInfoType> employeeInfo = new Vector<EmployeeInfoType>();
    @XmlElement(name = "EmployerInfo")
    protected CompanyNameType employerInfo;
    @XmlElement(name = "AdditionalLanguage")
    protected List<CustomerType.AdditionalLanguage> additionalLanguage = new Vector<CustomerType.AdditionalLanguage>();
    ...
    public List<PersonNameType> getPersonName() {
        if (personName == null) {
            personName = new Vector<PersonNameType>();
        }
    ...
    public List<CustomerType.Telephone> getTelephone() {
        if (telephone == null) {
            telephone = new Vector<CustomerType.Telephone>();
        }
    ...
    public List<CustomerType.Email> getEmail() {
        if (email == null) {
            email = new Vector<CustomerType.Email>();
        }
        return this.email;
    }
    ...
    public List<CustomerType.Address> getAddress() {
        if (address == null) {
            address = new Vector<CustomerType.Address>();
        }
        return this.address;
    }
    ...
    public List<CustomerType.URL> getURL() {
        if (url == null) {
            url = new Vector<CustomerType.URL>();
        }
        return this.url;
    }
    ...
    public List<CustomerType.CitizenCountryName> getCitizenCountryName() {
        if (citizenCountryName == null) {
            citizenCountryName = new Vector<CustomerType.CitizenCountryName>();
        }
    ...
    public List<CustomerType.PhysChallName> getPhysChallName() {
        if (physChallName == null) {
            physChallName = new Vector<CustomerType.PhysChallName>();
        }
    ...
    public List<CustomerType.PaymentForm> getPaymentForm() {
        if (paymentForm == null) {
            paymentForm = new Vector<CustomerType.PaymentForm>();
        }
    ...
    public List<RelatedTravelerType> getRelatedTraveler() {
        if (relatedTraveler == null) {
            relatedTraveler = new Vector<RelatedTravelerType>();
        }
    ...
    public List<ContactPersonType> getContactPerson() {
        if (contactPerson == null) {
            contactPerson = new Vector<ContactPersonType>();
        }
    ...
    public List<CustomerType.CustLoyalty> getCustLoyalty() {
        if (custLoyalty == null) {
            custLoyalty = new Vector<CustomerType.CustLoyalty>();
        }
    ...
    public List<EmployeeInfoType> getEmployeeInfo() {
        if (employeeInfo == null) {
            employeeInfo = new Vector<EmployeeInfoType>();
        }
    ...
    public List<CustomerType.AdditionalLanguage> getAdditionalLanguage() {
        if (additionalLanguage == null) {
            additionalLanguage = new Vector<CustomerType.AdditionalLanguage>();
        }
