...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_VehExchangeRS.Vehicle.VehRentalDetails.class
})
    ...
    implements Serializable
{
    ...
    protected List<VehicleRentalDetailsType.ConditionReport> conditionReport = new Vector<VehicleRentalDetailsType.ConditionReport>();
    ...
    public List<VehicleRentalDetailsType.ConditionReport> getConditionReport() {
        if (conditionReport == null) {
            conditionReport = new Vector<VehicleRentalDetailsType.ConditionReport>();
        }
