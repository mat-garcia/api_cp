...
@XmlSeeAlso({
    org.opentravel.ota2010a.OriginDestinationOptionType.FlightSegment.class,
    org.opentravel.ota2010a.PTCFareBreakdownType.PricingUnit.FareComponent.FlightLeg.class,
    org.opentravel.ota2010a.TravelSegmentType.Air.Reservation.class
})
    ...
    implements Serializable
{
    ...
    protected List<BookFlightSegmentType.BookingClassAvails> bookingClassAvails = new Vector<BookFlightSegmentType.BookingClassAvails>();
    @XmlElement(name = "Comment")
    protected List<FreeTextType> comment = new Vector<FreeTextType>();
    @XmlElement(name = "StopLocation")
    protected List<BookFlightSegmentType.StopLocation> stopLocation = new Vector<BookFlightSegmentType.StopLocation>();
    ...
    protected String e_TicketEligibility;
    ...
    public List<BookFlightSegmentType.BookingClassAvails> getBookingClassAvails() {
        if (bookingClassAvails == null) {
            bookingClassAvails = new Vector<BookFlightSegmentType.BookingClassAvails>();
        }
    ...
    public List<BookFlightSegmentType.StopLocation> getStopLocation() {
        if (stopLocation == null) {
            stopLocation = new Vector<BookFlightSegmentType.StopLocation>();
        }
    ...
    /**
     * Gets the value of the e_TicketEligibility property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the e_TicketEligibility property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setE_TicketEligibility(String value) {
        this.e_TicketEligibility = value;
    }
        ...
        implements Serializable
    {
        ...
        protected List<BookFlightSegmentType.BookingClassAvails.BookingClassAvail> bookingClassAvail = new Vector<BookFlightSegmentType.BookingClassAvails.BookingClassAvail>();
        ...
        public List<BookFlightSegmentType.BookingClassAvails.BookingClassAvail> getBookingClassAvail() {
            if (bookingClassAvail == null) {
                bookingClassAvail = new Vector<BookFlightSegmentType.BookingClassAvails.BookingClassAvail>();
            }
