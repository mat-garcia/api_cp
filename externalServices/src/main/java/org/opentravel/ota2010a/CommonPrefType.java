    ...
    implements Serializable
{
    ...
    protected List<NamePrefType> namePref = new Vector<NamePrefType>();
    @XmlElement(name = "PhonePref")
    protected List<PhonePrefType> phonePref = new Vector<PhonePrefType>();
    @XmlElement(name = "AddressPref")
    protected List<AddressPrefType> addressPref = new Vector<AddressPrefType>();
    ...
    protected List<InterestPrefType> interestPref = new Vector<InterestPrefType>();
    @XmlElement(name = "InsurancePref")
    protected List<InsurancePrefType> insurancePref = new Vector<InsurancePrefType>();
    @XmlElement(name = "SeatingPref")
    protected List<SeatingPrefType> seatingPref = new Vector<SeatingPrefType>();
    ...
    protected List<RelatedTravelerPrefType> relatedTravelerPref = new Vector<RelatedTravelerPrefType>();
    @XmlElement(name = "ContactPref")
    protected List<CommonPrefType.ContactPref> contactPref = new Vector<CommonPrefType.ContactPref>();
    ...
    public List<NamePrefType> getNamePref() {
        if (namePref == null) {
            namePref = new Vector<NamePrefType>();
        }
    ...
    public List<PhonePrefType> getPhonePref() {
        if (phonePref == null) {
            phonePref = new Vector<PhonePrefType>();
        }
    ...
    public List<AddressPrefType> getAddressPref() {
        if (addressPref == null) {
            addressPref = new Vector<AddressPrefType>();
        }
    ...
    public List<InterestPrefType> getInterestPref() {
        if (interestPref == null) {
            interestPref = new Vector<InterestPrefType>();
        }
    ...
    public List<InsurancePrefType> getInsurancePref() {
        if (insurancePref == null) {
            insurancePref = new Vector<InsurancePrefType>();
        }
    ...
    public List<SeatingPrefType> getSeatingPref() {
        if (seatingPref == null) {
            seatingPref = new Vector<SeatingPrefType>();
        }
    ...
    public List<RelatedTravelerPrefType> getRelatedTravelerPref() {
        if (relatedTravelerPref == null) {
            relatedTravelerPref = new Vector<RelatedTravelerPrefType>();
        }
    ...
    public List<CommonPrefType.ContactPref> getContactPref() {
        if (contactPref == null) {
            contactPref = new Vector<CommonPrefType.ContactPref>();
        }
