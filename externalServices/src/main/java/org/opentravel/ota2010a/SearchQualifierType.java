...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_CruiseCabinAvailRQ.SearchQualifiers.class,
    org.opentravel.ota2010a.OTA_CruiseCabinHoldRQ.SearchQualifiers.class,
    org.opentravel.ota2010a.OTA_CruiseCategoryAvailRQ.SearchQualifiers.class,
    ...
    implements Serializable
{
    ...
    protected List<SearchQualifierType.Status> status = new Vector<SearchQualifierType.Status>();
    ...
    public List<SearchQualifierType.Status> getStatus() {
        if (status == null) {
            status = new Vector<SearchQualifierType.Status>();
        }
        return this.status;
    }
