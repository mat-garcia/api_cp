...
@XmlSeeAlso({
    org.opentravel.ota2010a.AccountSpecificInformationType.RoomTypes.RoomType.class
})
    ...
    implements Serializable
{
    ...
    protected List<RoomTypeType.Occupancy> occupancy = new Vector<RoomTypeType.Occupancy>();
    ...
    public List<RoomTypeType.Occupancy> getOccupancy() {
        if (occupancy == null) {
            occupancy = new Vector<RoomTypeType.Occupancy>();
        }
