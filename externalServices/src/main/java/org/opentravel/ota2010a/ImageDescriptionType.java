...
@XmlSeeAlso({
    org.opentravel.ota2010a.ImageItemsType.ImageItem.class
})
    ...
    implements Serializable
{
    ...
    protected List<ImageDescriptionType.ImageFormat> imageFormat = new Vector<ImageDescriptionType.ImageFormat>();
    @XmlElement(name = "Description")
    protected List<ImageDescriptionType.Description> description = new Vector<ImageDescriptionType.Description>();
    ...
    public List<ImageDescriptionType.ImageFormat> getImageFormat() {
        if (imageFormat == null) {
            imageFormat = new Vector<ImageDescriptionType.ImageFormat>();
        }
    ...
    public List<ImageDescriptionType.Description> getDescription() {
        if (description == null) {
            description = new Vector<ImageDescriptionType.Description>();
        }
