...
@XmlSeeAlso({
    org.opentravel.ota2010a.PoliciesType.Policy.GuaranteePaymentPolicy.class
})
    ...
    implements Serializable
{
    ...
    protected List<RequiredPaymentsType.GuaranteePayment> guaranteePayment = new Vector<RequiredPaymentsType.GuaranteePayment>();
    ...
    public List<RequiredPaymentsType.GuaranteePayment> getGuaranteePayment() {
        if (guaranteePayment == null) {
            guaranteePayment = new Vector<RequiredPaymentsType.GuaranteePayment>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<RequiredPaymentsType.GuaranteePayment.Deadline> deadline = new Vector<RequiredPaymentsType.GuaranteePayment.Deadline>();
        @XmlElement(name = "Description")
        protected List<ParagraphType> description = new Vector<ParagraphType>();
        @XmlElement(name = "Address")
        protected List<RequiredPaymentsType.GuaranteePayment.Address> address = new Vector<RequiredPaymentsType.GuaranteePayment.Address>();
        ...
        public List<RequiredPaymentsType.GuaranteePayment.Deadline> getDeadline() {
            if (deadline == null) {
                deadline = new Vector<RequiredPaymentsType.GuaranteePayment.Deadline>();
            }
        ...
        public List<RequiredPaymentsType.GuaranteePayment.Address> getAddress() {
            if (address == null) {
                address = new Vector<RequiredPaymentsType.GuaranteePayment.Address>();
            }
            return this.address;
        }
