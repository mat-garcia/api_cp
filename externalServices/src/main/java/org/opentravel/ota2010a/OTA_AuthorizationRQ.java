 ...
 *         &lt;element name="AuthorizationDetail" type="{http://www.opentravel.org/OTA/2003/05}AuthorizationType" maxOccurs="99"/&gt;
 *       &lt;/sequence&gt;
...
@XmlRootElement(name = "OTA_AuthorizationRQ")
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "AuthorizationDetail", required = true)
    protected List<AuthorizationType> authorizationDetail = new Vector<AuthorizationType>();
     ...
     * 
     */
    public List<AuthorizationType> getAuthorizationDetail() {
        if (authorizationDetail == null) {
            authorizationDetail = new Vector<AuthorizationType>();
        }
