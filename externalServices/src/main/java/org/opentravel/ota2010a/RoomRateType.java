...
@XmlSeeAlso({
    org.opentravel.ota2010a.RoomStayType.RoomRates.RoomRate.class
})
    ...
    implements Serializable
{
    ...
    protected List<ParagraphType> roomRateDescription = new Vector<ParagraphType>();
    @XmlElement(name = "Features")
    protected RoomRateType.Features features;
    @XmlElement(name = "Total")
    protected TotalType total;
    @XmlElement(name = "Availability")
    protected List<RoomRateType.Availability> availability = new Vector<RoomRateType.Availability>();
    ...
    public List<ParagraphType> getRoomRateDescription() {
        if (roomRateDescription == null) {
            roomRateDescription = new Vector<ParagraphType>();
        }
    ...
    public List<RoomRateType.Availability> getAvailability() {
        if (availability == null) {
            availability = new Vector<RoomRateType.Availability>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<RoomRateType.Features.Feature> feature = new Vector<RoomRateType.Features.Feature>();
        ...
        public List<RoomRateType.Features.Feature> getFeature() {
            if (feature == null) {
                feature = new Vector<RoomRateType.Features.Feature>();
            }
            return this.feature;
        }
