...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_AirRulesRS.FareRuleResponseInfo.class
})
    ...
    implements Serializable
{
    ...
    protected List<FareRuleResponseInfoType.Routing> routing = new Vector<FareRuleResponseInfoType.Routing>();
    @XmlElement(name = "AdvisoryInfo")
    protected List<FareRuleResponseInfoType.AdvisoryInfo> advisoryInfo = new Vector<FareRuleResponseInfoType.AdvisoryInfo>();
    ...
    public List<FareRuleResponseInfoType.Routing> getRouting() {
        if (routing == null) {
            routing = new Vector<FareRuleResponseInfoType.Routing>();
        }
        return this.routing;
    }
    ...
    public List<FareRuleResponseInfoType.AdvisoryInfo> getAdvisoryInfo() {
        if (advisoryInfo == null) {
            advisoryInfo = new Vector<FareRuleResponseInfoType.AdvisoryInfo>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<FareRuleResponseInfoType.Routing.Info> info = new Vector<FareRuleResponseInfoType.Routing.Info>();
        ...
        public List<FareRuleResponseInfoType.Routing.Info> getInfo() {
            if (info == null) {
                info = new Vector<FareRuleResponseInfoType.Routing.Info>();
            }
            return this.info;
        }
