...
/**
 * The VehicleRetrieveInfoRQType complex type defines the supplemental data by which an existing reservation can be identified for retrieval
 * 
 ...
 *         &lt;element name="SearchDateRange" maxOccurs="3" minOccurs="0"&gt;
 *           &lt;complexType&gt;
 *             &lt;complexContent&gt;
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_VehRetResRQ.VehRetResRQInfo.class
})
    ...
    implements Serializable
{
    ...
    protected List<VehicleRetrieveResRQAdditionalInfoType.SearchDateRange> searchDateRange = new Vector<VehicleRetrieveResRQAdditionalInfoType.SearchDateRange>();
    ...
    public List<VehicleRetrieveResRQAdditionalInfoType.SearchDateRange> getSearchDateRange() {
        if (searchDateRange == null) {
            searchDateRange = new Vector<VehicleRetrieveResRQAdditionalInfoType.SearchDateRange>();
        }
