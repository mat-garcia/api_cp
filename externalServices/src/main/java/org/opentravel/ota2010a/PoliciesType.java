...
@XmlSeeAlso({
    org.opentravel.ota2010a.HotelDescriptiveContentType.Policies.class
})
    ...
    implements Serializable
{
    ...
    protected List<PoliciesType.Policy> policy = new Vector<PoliciesType.Policy>();
    ...
    public List<PoliciesType.Policy> getPolicy() {
        if (policy == null) {
            policy = new Vector<PoliciesType.Policy>();
        }
        return this.policy;
    }
        ...
        implements Serializable
    {
            ...
            implements Serializable
        {
            ...
            protected List<PoliciesType.Policy.CheckoutCharges.CheckoutCharge> checkoutCharge = new Vector<PoliciesType.Policy.CheckoutCharges.CheckoutCharge>();
            ...
            public List<PoliciesType.Policy.CheckoutCharges.CheckoutCharge> getCheckoutCharge() {
                if (checkoutCharge == null) {
                    checkoutCharge = new Vector<PoliciesType.Policy.CheckoutCharges.CheckoutCharge>();
                }
            ...
            implements Serializable
        {
            ...
            protected List<PoliciesType.Policy.CommissionPolicy.PaymentCompany> paymentCompany = new Vector<PoliciesType.Policy.CommissionPolicy.PaymentCompany>();
            ...
            public List<PoliciesType.Policy.CommissionPolicy.PaymentCompany> getPaymentCompany() {
                if (paymentCompany == null) {
                    paymentCompany = new Vector<PoliciesType.Policy.CommissionPolicy.PaymentCompany>();
                }
            ...
            implements Serializable
        {
            ...
            protected List<FeeType> feePolicy = new Vector<FeeType>();
            ...
            implements Serializable
        {
            ...
            protected List<PoliciesType.Policy.PetsPolicies.PetsPolicy> petsPolicy = new Vector<PoliciesType.Policy.PetsPolicies.PetsPolicy>();
            ...
            public List<PoliciesType.Policy.PetsPolicies.PetsPolicy> getPetsPolicy() {
                if (petsPolicy == null) {
                    petsPolicy = new Vector<PoliciesType.Policy.PetsPolicies.PetsPolicy>();
                }
            ...
            implements Serializable
        {
            ...
            protected List<PoliciesType.Policy.PolicyInfoCodes.PolicyInfoCode> policyInfoCode = new Vector<PoliciesType.Policy.PolicyInfoCodes.PolicyInfoCode>();
            ...
            public List<PoliciesType.Policy.PolicyInfoCodes.PolicyInfoCode> getPolicyInfoCode() {
                if (policyInfoCode == null) {
                    policyInfoCode = new Vector<PoliciesType.Policy.PolicyInfoCodes.PolicyInfoCode>();
                }
            ...
            implements Serializable
        {
            ...
            protected List<PoliciesType.Policy.StayRequirements.StayRequirement> stayRequirement = new Vector<PoliciesType.Policy.StayRequirements.StayRequirement>();
            ...
            public List<PoliciesType.Policy.StayRequirements.StayRequirement> getStayRequirement() {
                if (stayRequirement == null) {
                    stayRequirement = new Vector<PoliciesType.Policy.StayRequirements.StayRequirement>();
                }
            ...
            implements Serializable
        {
            ...
            protected List<PoliciesType.Policy.TaxPolicies.TaxPolicy> taxPolicy = new Vector<PoliciesType.Policy.TaxPolicies.TaxPolicy>();
            ...
            public List<PoliciesType.Policy.TaxPolicies.TaxPolicy> getTaxPolicy() {
                if (taxPolicy == null) {
                    taxPolicy = new Vector<PoliciesType.Policy.TaxPolicies.TaxPolicy>();
                }
