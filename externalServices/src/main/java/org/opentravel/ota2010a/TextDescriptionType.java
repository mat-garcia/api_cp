...
@XmlSeeAlso({
    org.opentravel.ota2010a.TextItemsType.TextItem.class
})
    ...
    implements Serializable
{
    ...
    protected List<TextDescriptionType.Description> description = new Vector<TextDescriptionType.Description>();
    ...
    public List<TextDescriptionType.Description> getDescription() {
        if (description == null) {
            description = new Vector<TextDescriptionType.Description>();
        }
