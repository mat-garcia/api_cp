 ...
 *       &lt;attribute name="Type" type="{http://www.opentravel.org/OTA/2003/05}AlphaLength3" /&gt;
    ...
    implements Serializable
{
    ...
    protected List<ExtrasCoreType.SubCategory> subCategory = new Vector<ExtrasCoreType.SubCategory>();
    ...
    protected List<String> listOfInventoryItemRPH = new Vector<String>();
    @XmlAttribute(name = "ListofRoomRPH")
    protected List<String> listofRoomRPH = new Vector<String>();
     ...
     * {@link ExtrasCoreType.SubCategory }
     * 
     * 
     */
    public List<ExtrasCoreType.SubCategory> getSubCategory() {
        if (subCategory == null) {
            subCategory = new Vector<ExtrasCoreType.SubCategory>();
        }
    ...
    public List<String> getListOfInventoryItemRPH() {
        if (listOfInventoryItemRPH == null) {
            listOfInventoryItemRPH = new Vector<String>();
        }
    ...
    public List<String> getListofRoomRPH() {
        if (listofRoomRPH == null) {
            listofRoomRPH = new Vector<String>();
        }
