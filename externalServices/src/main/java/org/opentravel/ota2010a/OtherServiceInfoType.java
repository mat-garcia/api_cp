...
@XmlSeeAlso({
    org.opentravel.ota2010a.SpecialReqDetailsType.OtherServiceInformations.OtherServiceInformation.class
})
    ...
    implements Serializable
{
    ...
    protected List<OtherServiceInfoType.TravelerRefNumber> travelerRefNumber = new Vector<OtherServiceInfoType.TravelerRefNumber>();
    ...
    public List<OtherServiceInfoType.TravelerRefNumber> getTravelerRefNumber() {
        if (travelerRefNumber == null) {
            travelerRefNumber = new Vector<OtherServiceInfoType.TravelerRefNumber>();
        }
