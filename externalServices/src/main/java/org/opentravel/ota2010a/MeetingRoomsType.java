...
@XmlSeeAlso({
    org.opentravel.ota2010a.FacilityInfoType.MeetingRooms.class
})
    ...
    implements Serializable
{
    ...
    protected List<MeetingRoomsType.MeetingRoom> meetingRoom = new Vector<MeetingRoomsType.MeetingRoom>();
    ...
    public List<MeetingRoomsType.MeetingRoom> getMeetingRoom() {
        if (meetingRoom == null) {
            meetingRoom = new Vector<MeetingRoomsType.MeetingRoom>();
        }
        ...
        implements Serializable
    {
            ...
            implements Serializable
        {
            ...
            protected List<MeetingRoomCapacityType> meetingRoomCapacity = new Vector<MeetingRoomCapacityType>();
            ...
            public List<MeetingRoomCapacityType> getMeetingRoomCapacity() {
                if (meetingRoomCapacity == null) {
                    meetingRoomCapacity = new Vector<MeetingRoomCapacityType>();
                }
