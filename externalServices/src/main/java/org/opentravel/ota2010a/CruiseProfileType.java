    ...
    implements Serializable
{
    ...
    protected List<CruiseProfileType.CruiseProfile> cruiseProfile = new Vector<CruiseProfileType.CruiseProfile>();
    ...
    public List<CruiseProfileType.CruiseProfile> getCruiseProfile() {
        if (cruiseProfile == null) {
            cruiseProfile = new Vector<CruiseProfileType.CruiseProfile>();
        }
