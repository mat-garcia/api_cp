...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_AirFareDisplayRQ.TravelPreferences.class,
    org.opentravel.ota2010a.OTA_AirLowFareSearchRQ.TravelPreferences.class
})
    ...
    implements Serializable
{
    ...
    protected List<AirSearchPrefsType.VendorPref> vendorPref = new Vector<AirSearchPrefsType.VendorPref>();
    @XmlElement(name = "FlightTypePref")
    protected List<AirSearchPrefsType.FlightTypePref> flightTypePref = new Vector<AirSearchPrefsType.FlightTypePref>();
    @XmlElement(name = "FareRestrictPref")
    protected List<AirSearchPrefsType.FareRestrictPref> fareRestrictPref = new Vector<AirSearchPrefsType.FareRestrictPref>();
    ...
    protected List<AirSearchPrefsType.CabinPref> cabinPref = new Vector<AirSearchPrefsType.CabinPref>();
    @XmlElement(name = "TicketDistribPref")
    protected List<AirSearchPrefsType.TicketDistribPref> ticketDistribPref = new Vector<AirSearchPrefsType.TicketDistribPref>();
    ...
    public List<AirSearchPrefsType.VendorPref> getVendorPref() {
        if (vendorPref == null) {
            vendorPref = new Vector<AirSearchPrefsType.VendorPref>();
        }
    ...
    public List<AirSearchPrefsType.FlightTypePref> getFlightTypePref() {
        if (flightTypePref == null) {
            flightTypePref = new Vector<AirSearchPrefsType.FlightTypePref>();
        }
    ...
    public List<AirSearchPrefsType.FareRestrictPref> getFareRestrictPref() {
        if (fareRestrictPref == null) {
            fareRestrictPref = new Vector<AirSearchPrefsType.FareRestrictPref>();
        }
    ...
    public List<AirSearchPrefsType.CabinPref> getCabinPref() {
        if (cabinPref == null) {
            cabinPref = new Vector<AirSearchPrefsType.CabinPref>();
        }
    ...
    public List<AirSearchPrefsType.TicketDistribPref> getTicketDistribPref() {
        if (ticketDistribPref == null) {
            ticketDistribPref = new Vector<AirSearchPrefsType.TicketDistribPref>();
        }
