    ...
    implements Serializable
{
    ...
    protected List<DestActivityReservationType.TravelerCount> travelerCount = new Vector<DestActivityReservationType.TravelerCount>();
    ...
    public List<DestActivityReservationType.TravelerCount> getTravelerCount() {
        if (travelerCount == null) {
            travelerCount = new Vector<DestActivityReservationType.TravelerCount>();
        }
