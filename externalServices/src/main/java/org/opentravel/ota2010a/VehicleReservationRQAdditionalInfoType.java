...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_VehResRQ.VehResRQInfo.class
})
    ...
    implements Serializable
{
    ...
    protected List<VehicleReservationRQAdditionalInfoType.RentalPaymentPref> rentalPaymentPref = new Vector<VehicleReservationRQAdditionalInfoType.RentalPaymentPref>();
    ...
    public List<VehicleReservationRQAdditionalInfoType.RentalPaymentPref> getRentalPaymentPref() {
        if (rentalPaymentPref == null) {
            rentalPaymentPref = new Vector<VehicleReservationRQAdditionalInfoType.RentalPaymentPref>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<VehicleReservationRQAdditionalInfoType.CoveragePrefs.CoveragePref> coveragePref = new Vector<VehicleReservationRQAdditionalInfoType.CoveragePrefs.CoveragePref>();
        ...
        public List<VehicleReservationRQAdditionalInfoType.CoveragePrefs.CoveragePref> getCoveragePref() {
            if (coveragePref == null) {
                coveragePref = new Vector<VehicleReservationRQAdditionalInfoType.CoveragePrefs.CoveragePref>();
            }
