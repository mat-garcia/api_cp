...
@XmlSeeAlso({
    org.opentravel.ota2010a.SeatMapDetailsType.CabinClass.class
})
    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        protected List<RowDetailsType> airRow = new Vector<RowDetailsType>();
        ...
        public List<RowDetailsType> getAirRow() {
            if (airRow == null) {
                airRow = new Vector<RowDetailsType>();
            }
            return this.airRow;
        }
