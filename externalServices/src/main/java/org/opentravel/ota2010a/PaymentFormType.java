...
@XmlSeeAlso({
    ...
    org.opentravel.ota2010a.CompanyInfoType.PaymentForm.class,
    HotelPaymentFormType.class,
    org.opentravel.ota2010a.GuaranteeType.GuaranteesAccepted.GuaranteeAccepted.class,
    org.opentravel.ota2010a.CustomerType.PaymentForm.class,
    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        protected List<PaymentFormType.LoyaltyRedemption.LoyaltyCertificate> loyaltyCertificate = new Vector<PaymentFormType.LoyaltyRedemption.LoyaltyCertificate>();
        ...
        public List<PaymentFormType.LoyaltyRedemption.LoyaltyCertificate> getLoyaltyCertificate() {
            if (loyaltyCertificate == null) {
                loyaltyCertificate = new Vector<PaymentFormType.LoyaltyRedemption.LoyaltyCertificate>();
            }
        ...
        implements Serializable
    {
        ...
        protected Boolean paperMCO_ExistInd;
        ...
        protected List<String> couponRPHs = new Vector<String>();
        ...
        /**
         * Gets the value of the paperMCO_ExistInd property.
         * 
         * @return
         *     possible object is
         *     {@link Boolean }
         *     
         */
        public Boolean isPaperMCO_ExistInd() {
            return paperMCO_ExistInd;
        }

        /**
         * Sets the value of the paperMCO_ExistInd property.
         * 
         * @param value
         *     allowed object is
         *     {@link Boolean }
         *     
         */
        public void setPaperMCO_ExistInd(Boolean value) {
            this.paperMCO_ExistInd = value;
        }
        ...
        implements Serializable
    {
        ...
        protected List<PaymentFormType.Ticket.ConjunctionTicketNbr> conjunctionTicketNbr = new Vector<PaymentFormType.Ticket.ConjunctionTicketNbr>();
        @XmlAttribute(name = "TicketNumber")
        protected String ticketNumber;
        ...
        public List<PaymentFormType.Ticket.ConjunctionTicketNbr> getConjunctionTicketNbr() {
            if (conjunctionTicketNbr == null) {
                conjunctionTicketNbr = new Vector<PaymentFormType.Ticket.ConjunctionTicketNbr>();
            }
            ...
            implements Serializable
        {
            ...
            protected List<String> coupons = new Vector<String>();
