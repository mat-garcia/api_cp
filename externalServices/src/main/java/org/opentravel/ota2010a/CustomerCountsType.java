    ...
    implements Serializable
{
    ...
    protected List<CustomerCountsType.CustomerCount> customerCount = new Vector<CustomerCountsType.CustomerCount>();
    ...
    public List<CustomerCountsType.CustomerCount> getCustomerCount() {
        if (customerCount == null) {
            customerCount = new Vector<CustomerCountsType.CustomerCount>();
        }
