    ...
    implements Serializable
{
    ...
    protected List<PaymentDetailType> rentalPaymentAmount = new Vector<PaymentDetailType>();
    ...
    protected List<OffLocationServicePricedType> pricedOffLocService = new Vector<OffLocationServicePricedType>();
    ...
    public List<PaymentDetailType> getRentalPaymentAmount() {
        if (rentalPaymentAmount == null) {
            rentalPaymentAmount = new Vector<PaymentDetailType>();
        }
    ...
    public List<OffLocationServicePricedType> getPricedOffLocService() {
        if (pricedOffLocService == null) {
            pricedOffLocService = new Vector<OffLocationServicePricedType>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<FormattedTextType> vendorMessage = new Vector<FormattedTextType>();
        ...
        public List<FormattedTextType> getVendorMessage() {
            if (vendorMessage == null) {
                vendorMessage = new Vector<FormattedTextType>();
            }
