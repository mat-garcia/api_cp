...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_AirFareDisplayRS.FareDisplayInfos.FareDisplayInfo.PricingInfo.class,
    org.opentravel.ota2010a.PTCFareBreakdownType.PassengerFare.class,
    org.opentravel.ota2010a.AirItineraryPricingInfoType.ItinTotalFare.class
})
    ...
    implements Serializable
{
    ...
    protected List<FareType.EquivFare> equivFare = new Vector<FareType.EquivFare>();
    ...
    protected List<FareType.FareBaggageAllowance> fareBaggageAllowance = new Vector<FareType.FareBaggageAllowance>();
    @XmlElement(name = "TourCode")
    protected FareType.TourCode tourCode;
    @XmlElement(name = "Remark")
    protected List<FareType.Remark> remark = new Vector<FareType.Remark>();
    ...
    public List<FareType.EquivFare> getEquivFare() {
        if (equivFare == null) {
            equivFare = new Vector<FareType.EquivFare>();
        }
    ...
    public List<FareType.FareBaggageAllowance> getFareBaggageAllowance() {
        if (fareBaggageAllowance == null) {
            fareBaggageAllowance = new Vector<FareType.FareBaggageAllowance>();
        }
    ...
    public List<FareType.Remark> getRemark() {
        if (remark == null) {
            remark = new Vector<FareType.Remark>();
        }
        return this.remark;
    }
        ...
        implements Serializable
    {
        ...
        protected List<FareType.Discounts.Discount> discount = new Vector<FareType.Discounts.Discount>();
        ...
        public List<FareType.Discounts.Discount> getDiscount() {
            if (discount == null) {
                discount = new Vector<FareType.Discounts.Discount>();
            }
        ...
        implements Serializable
    {
        ...
        protected List<FareType.ExchangeInfo.CouponInfo> couponInfo = new Vector<FareType.ExchangeInfo.CouponInfo>();
        ...
        public List<FareType.ExchangeInfo.CouponInfo> getCouponInfo() {
            if (couponInfo == null) {
                couponInfo = new Vector<FareType.ExchangeInfo.CouponInfo>();
            }
        ...
        implements Serializable
    {
        ...
        protected List<AirFeeType> fee = new Vector<AirFeeType>();
        @XmlAttribute(name = "Amount")
        protected BigDecimal amount;
        @XmlAttribute(name = "CurrencyCode")
        protected String currencyCode;
