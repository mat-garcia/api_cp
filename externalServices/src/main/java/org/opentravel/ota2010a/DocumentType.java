...
@XmlSeeAlso({
    org.opentravel.ota2010a.AirCheckInType.PassengerFlightInfo.API_Info.class,
    org.opentravel.ota2010a.AirTravelerType.Document.class
})
    ...
    implements Serializable
{
    ...
    protected List<String> docLimitations = new Vector<String>();
    ...
    public List<String> getDocLimitations() {
        if (docLimitations == null) {
            docLimitations = new Vector<String>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<String> additionalPersonName = new Vector<String>();
        ...
        public List<String> getAdditionalPersonName() {
            if (additionalPersonName == null) {
                additionalPersonName = new Vector<String>();
            }
