...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_VehLocDetailsNotifRQ.LocationDetails.LocationDetail.Vehicles.class
})
    ...
    implements Serializable
{
    ...
    protected List<VehicleLocationVehiclesType.Vehicle> vehicle = new Vector<VehicleLocationVehiclesType.Vehicle>();
    ...
    public List<VehicleLocationVehiclesType.Vehicle> getVehicle() {
        if (vehicle == null) {
            vehicle = new Vector<VehicleLocationVehiclesType.Vehicle>();
        }
        return this.vehicle;
    }
        ...
        implements Serializable
    {
        ...
        protected List<FormattedTextType> text = new Vector<FormattedTextType>();
        ...
        public List<FormattedTextType> getText() {
            if (text == null) {
                text = new Vector<FormattedTextType>();
            }
            return this.text;
        }
        ...
        implements Serializable
    {
        ...
        protected List<VehicleLocationVehiclesType.VehicleInfos.VehicleInfo> vehicleInfo = new Vector<VehicleLocationVehiclesType.VehicleInfos.VehicleInfo>();
        ...
        public List<VehicleLocationVehiclesType.VehicleInfos.VehicleInfo> getVehicleInfo() {
            if (vehicleInfo == null) {
                vehicleInfo = new Vector<VehicleLocationVehiclesType.VehicleInfos.VehicleInfo>();
            }
