...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_VehModifyRQ.VehModifyRQCore.class
})
    ...
    implements Serializable
{
    ...
    protected List<VehicleModifyRQCoreType.DriverType> driverType = new Vector<VehicleModifyRQCoreType.DriverType>();
    ...
    protected List<VehicleModifyRQCoreType.RateDistance> rateDistance = new Vector<VehicleModifyRQCoreType.RateDistance>();
    ...
    public List<VehicleModifyRQCoreType.DriverType> getDriverType() {
        if (driverType == null) {
            driverType = new Vector<VehicleModifyRQCoreType.DriverType>();
        }
    ...
    public List<VehicleModifyRQCoreType.RateDistance> getRateDistance() {
        if (rateDistance == null) {
            rateDistance = new Vector<VehicleModifyRQCoreType.RateDistance>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<VehicleModifyRQCoreType.SpecialEquipPrefs.SpecialEquipPref> specialEquipPref = new Vector<VehicleModifyRQCoreType.SpecialEquipPrefs.SpecialEquipPref>();
        ...
        public List<VehicleModifyRQCoreType.SpecialEquipPrefs.SpecialEquipPref> getSpecialEquipPref() {
            if (specialEquipPref == null) {
                specialEquipPref = new Vector<VehicleModifyRQCoreType.SpecialEquipPrefs.SpecialEquipPref>();
            }
