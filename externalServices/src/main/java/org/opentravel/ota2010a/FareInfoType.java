...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_AirRulesRQ.RuleReqInfo.class,
    org.opentravel.ota2010a.PTCFareBreakdownType.FareInfo.class,
    org.opentravel.ota2010a.FareRuleResponseInfoType.FareRuleInfo.class,
    org.opentravel.ota2010a.AirItineraryPricingInfoType.FareInfos.FareInfo.class
})
    ...
    implements Serializable
{
    ...
    protected List<FareInfoType.FareReference> fareReference = new Vector<FareInfoType.FareReference>();
    ...
    protected List<FareInfoType.Date> date = new Vector<FareInfoType.Date>();
    @XmlElement(name = "FareInfo")
    protected List<FareInfoType.FareInfo> fareInfo = new Vector<FareInfoType.FareInfo>();
    @XmlElement(name = "DiscountPricing")
    protected FareInfoType.DiscountPricing discountPricing;
    @XmlElement(name = "City")
    protected List<FareInfoType.City> city = new Vector<FareInfoType.City>();
    @XmlElement(name = "Airport")
    protected List<FareInfoType.Airport> airport = new Vector<FareInfoType.Airport>();
    ...
    public List<FareInfoType.FareReference> getFareReference() {
        if (fareReference == null) {
            fareReference = new Vector<FareInfoType.FareReference>();
        }
    ...
    public List<FareInfoType.Date> getDate() {
        if (date == null) {
            date = new Vector<FareInfoType.Date>();
        }
        return this.date;
    }
    ...
    public List<FareInfoType.FareInfo> getFareInfo() {
        if (fareInfo == null) {
            fareInfo = new Vector<FareInfoType.FareInfo>();
        }
    ...
    public List<FareInfoType.City> getCity() {
        if (city == null) {
            city = new Vector<FareInfoType.City>();
        }
        return this.city;
    }
    ...
    public List<FareInfoType.Airport> getAirport() {
        if (airport == null) {
            airport = new Vector<FareInfoType.Airport>();
        }
        return this.airport;
    }
        ...
        implements Serializable
    {
        ...
        @XmlElement(name = "Date")
        protected List<FareInfoType.FareInfo.Date> date = new Vector<FareInfoType.FareInfo.Date>();
        @XmlElement(name = "Fare")
        protected FareInfoType.FareInfo.Fare fare;
        @XmlElement(name = "PTC")
        protected List<FareInfoType.FareInfo.PTC> ptc = new Vector<FareInfoType.FareInfo.PTC>();
        ...
        public List<FareInfoType.FareInfo.Date> getDate() {
            if (date == null) {
                date = new Vector<FareInfoType.FareInfo.Date>();
            }
            return this.date;
        }
        ...
        public List<FareInfoType.FareInfo.PTC> getPTC() {
            if (ptc == null) {
                ptc = new Vector<FareInfoType.FareInfo.PTC>();
            }
            return this.ptc;
        }
            ...
            implements Serializable
        {
            ...
            protected BigDecimal baseNUC_Amount;
            ...
            /**
             * Gets the value of the baseNUC_Amount property.
             * 
             * @return
             *     possible object is
             *     {@link BigDecimal }
            ...
            public BigDecimal getBaseNUC_Amount() {
                return baseNUC_Amount;
            }

            /**
             * Sets the value of the baseNUC_Amount property.
             * 
             * @param value
             *     allowed object is
             *     {@link BigDecimal }
             *     
             */
            public void setBaseNUC_Amount(BigDecimal value) {
                this.baseNUC_Amount = value;
            }
