...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_VehAvailRateRQ.VehAvailRQCore.class
})
    ...
    implements Serializable
{
    ...
    protected List<VehicleAvailRQCoreType.DriverType> driverType = new Vector<VehicleAvailRQCoreType.DriverType>();
    @XmlElement(name = "RateQualifier")
    protected List<VehicleAvailRQCoreType.RateQualifier> rateQualifier = new Vector<VehicleAvailRQCoreType.RateQualifier>();
    ...
    public List<VehicleAvailRQCoreType.DriverType> getDriverType() {
        if (driverType == null) {
            driverType = new Vector<VehicleAvailRQCoreType.DriverType>();
        }
    ...
    public List<VehicleAvailRQCoreType.RateQualifier> getRateQualifier() {
        if (rateQualifier == null) {
            rateQualifier = new Vector<VehicleAvailRQCoreType.RateQualifier>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<VehicleAvailRQCoreType.SpecialEquipPrefs.SpecialEquipPref> specialEquipPref = new Vector<VehicleAvailRQCoreType.SpecialEquipPrefs.SpecialEquipPref>();
        ...
        public List<VehicleAvailRQCoreType.SpecialEquipPrefs.SpecialEquipPref> getSpecialEquipPref() {
            if (specialEquipPref == null) {
                specialEquipPref = new Vector<VehicleAvailRQCoreType.SpecialEquipPrefs.SpecialEquipPref>();
            }
        ...
        implements Serializable
    {
        ...
        protected List<VehicleAvailRQCoreType.VehPrefs.VehPref> vehPref = new Vector<VehicleAvailRQCoreType.VehPrefs.VehPref>();
        ...
        public List<VehicleAvailRQCoreType.VehPrefs.VehPref> getVehPref() {
            if (vehPref == null) {
                vehPref = new Vector<VehicleAvailRQCoreType.VehPrefs.VehPref>();
            }
            return this.vehPref;
        }
        ...
        implements Serializable
    {
        ...
        protected List<VehicleAvailRQCoreType.VendorPrefs.VendorPref> vendorPref = new Vector<VehicleAvailRQCoreType.VendorPrefs.VendorPref>();
        ...
        public List<VehicleAvailRQCoreType.VendorPrefs.VendorPref> getVendorPref() {
            if (vendorPref == null) {
                vendorPref = new Vector<VehicleAvailRQCoreType.VendorPrefs.VendorPref>();
            }
