    ...
    implements Serializable
{
    ...
    protected List<CompanyInfoType.AddressInfo> addressInfo = new Vector<CompanyInfoType.AddressInfo>();
    @XmlElement(name = "TelephoneInfo")
    protected List<CompanyInfoType.TelephoneInfo> telephoneInfo = new Vector<CompanyInfoType.TelephoneInfo>();
    @XmlElement(name = "Email")
    protected List<CompanyInfoType.Email> email = new Vector<CompanyInfoType.Email>();
    @XmlElement(name = "URL")
    protected List<URL_Type> url = new Vector<URL_Type>();
    @XmlElement(name = "BusinessLocale")
    protected List<AddressType> businessLocale = new Vector<AddressType>();
    @XmlElement(name = "PaymentForm")
    protected List<CompanyInfoType.PaymentForm> paymentForm = new Vector<CompanyInfoType.PaymentForm>();
    @XmlElement(name = "ContactPerson")
    protected List<ContactPersonType> contactPerson = new Vector<ContactPersonType>();
    @XmlElement(name = "TravelArranger")
    protected List<TravelArrangerType> travelArranger = new Vector<TravelArrangerType>();
    @XmlElement(name = "LoyaltyProgram")
    protected List<LoyaltyProgramType> loyaltyProgram = new Vector<LoyaltyProgramType>();
    @XmlElement(name = "TripPurpose")
    protected List<CompanyInfoType.TripPurpose> tripPurpose = new Vector<CompanyInfoType.TripPurpose>();
    ...
    public List<CompanyInfoType.AddressInfo> getAddressInfo() {
        if (addressInfo == null) {
            addressInfo = new Vector<CompanyInfoType.AddressInfo>();
        }
    ...
    public List<CompanyInfoType.TelephoneInfo> getTelephoneInfo() {
        if (telephoneInfo == null) {
            telephoneInfo = new Vector<CompanyInfoType.TelephoneInfo>();
        }
    ...
    public List<CompanyInfoType.Email> getEmail() {
        if (email == null) {
            email = new Vector<CompanyInfoType.Email>();
        }
        return this.email;
    }
    ...
    public List<AddressType> getBusinessLocale() {
        if (businessLocale == null) {
            businessLocale = new Vector<AddressType>();
        }
    ...
    public List<CompanyInfoType.PaymentForm> getPaymentForm() {
        if (paymentForm == null) {
            paymentForm = new Vector<CompanyInfoType.PaymentForm>();
        }
    ...
    public List<TravelArrangerType> getTravelArranger() {
        if (travelArranger == null) {
            travelArranger = new Vector<TravelArrangerType>();
        }
    ...
    public List<LoyaltyProgramType> getLoyaltyProgram() {
        if (loyaltyProgram == null) {
            loyaltyProgram = new Vector<LoyaltyProgramType>();
        }
    ...
    public List<CompanyInfoType.TripPurpose> getTripPurpose() {
        if (tripPurpose == null) {
            tripPurpose = new Vector<CompanyInfoType.TripPurpose>();
        }
