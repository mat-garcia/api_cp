    ...
    implements Serializable
{
    ...
    protected List<LoyaltyPointsAccrualsType.SelectedLoyalty> selectedLoyalty = new Vector<LoyaltyPointsAccrualsType.SelectedLoyalty>();
    ...
    public List<LoyaltyPointsAccrualsType.SelectedLoyalty> getSelectedLoyalty() {
        if (selectedLoyalty == null) {
            selectedLoyalty = new Vector<LoyaltyPointsAccrualsType.SelectedLoyalty>();
        }
