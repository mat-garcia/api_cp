    ...
    implements Serializable
{
    ...
    protected List<PTCFareBreakdownType.PassengerFare> passengerFare = new Vector<PTCFareBreakdownType.PassengerFare>();
    @XmlElement(name = "TravelerRefNumber")
    protected List<PTCFareBreakdownType.TravelerRefNumber> travelerRefNumber = new Vector<PTCFareBreakdownType.TravelerRefNumber>();
    ...
    protected List<PTCFareBreakdownType.FareInfo> fareInfo = new Vector<PTCFareBreakdownType.FareInfo>();
    @XmlElement(name = "PricingUnit")
    protected List<PTCFareBreakdownType.PricingUnit> pricingUnit = new Vector<PTCFareBreakdownType.PricingUnit>();
    ...
    public List<PTCFareBreakdownType.PassengerFare> getPassengerFare() {
        if (passengerFare == null) {
            passengerFare = new Vector<PTCFareBreakdownType.PassengerFare>();
        }
    ...
    public List<PTCFareBreakdownType.TravelerRefNumber> getTravelerRefNumber() {
        if (travelerRefNumber == null) {
            travelerRefNumber = new Vector<PTCFareBreakdownType.TravelerRefNumber>();
        }
    ...
    public List<PTCFareBreakdownType.FareInfo> getFareInfo() {
        if (fareInfo == null) {
            fareInfo = new Vector<PTCFareBreakdownType.FareInfo>();
        }
    ...
    public List<PTCFareBreakdownType.PricingUnit> getPricingUnit() {
        if (pricingUnit == null) {
            pricingUnit = new Vector<PTCFareBreakdownType.PricingUnit>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<PTCFareBreakdownType.Endorsements.Endorsement> endorsement = new Vector<PTCFareBreakdownType.Endorsements.Endorsement>();
        ...
        public List<PTCFareBreakdownType.Endorsements.Endorsement> getEndorsement() {
            if (endorsement == null) {
                endorsement = new Vector<PTCFareBreakdownType.Endorsements.Endorsement>();
            }
        ...
        implements Serializable
    {
        ...
        protected List<FareBasisCodeType> fareBasisCode = new Vector<FareBasisCodeType>();
        ...
        public List<FareBasisCodeType> getFareBasisCode() {
            if (fareBasisCode == null) {
                fareBasisCode = new Vector<FareBasisCodeType>();
            }
        ...
        implements Serializable
    {
            ...
            implements Serializable
        {
            ...
            protected List<PTCFareBreakdownType.PassengerFare.TicketFeeDetail.Fee> fee = new Vector<PTCFareBreakdownType.PassengerFare.TicketFeeDetail.Fee>();
            @XmlElement(name = "Total")
            protected List<PTCFareBreakdownType.PassengerFare.TicketFeeDetail.Total> total = new Vector<PTCFareBreakdownType.PassengerFare.TicketFeeDetail.Total>();
            ...
            public List<PTCFareBreakdownType.PassengerFare.TicketFeeDetail.Fee> getFee() {
                if (fee == null) {
                    fee = new Vector<PTCFareBreakdownType.PassengerFare.TicketFeeDetail.Fee>();
                }
                return this.fee;
            }
            ...
            public List<PTCFareBreakdownType.PassengerFare.TicketFeeDetail.Total> getTotal() {
                if (total == null) {
                    total = new Vector<PTCFareBreakdownType.PassengerFare.TicketFeeDetail.Total>();
                }
                return this.total;
            }
                ...
                implements Serializable
            {
                    ...
                    implements Serializable
                {
                    ...
                    protected List<AirTaxType> tax = new Vector<AirTaxType>();
        ...
        implements Serializable
    {
        ...
        protected List<PTCFareBreakdownType.PricingUnit.FareComponent> fareComponent = new Vector<PTCFareBreakdownType.PricingUnit.FareComponent>();
        ...
        public List<PTCFareBreakdownType.PricingUnit.FareComponent> getFareComponent() {
            if (fareComponent == null) {
                fareComponent = new Vector<PTCFareBreakdownType.PricingUnit.FareComponent>();
            }
            ...
            implements Serializable
        {
            ...
            protected List<PTCFareBreakdownType.PricingUnit.FareComponent.FlightLeg> flightLeg = new Vector<PTCFareBreakdownType.PricingUnit.FareComponent.FlightLeg>();
            ...
            public List<PTCFareBreakdownType.PricingUnit.FareComponent.FlightLeg> getFlightLeg() {
                if (flightLeg == null) {
                    flightLeg = new Vector<PTCFareBreakdownType.PricingUnit.FareComponent.FlightLeg>();
                }
        ...
        implements Serializable
    {
        ...
        protected List<PTCFareBreakdownType.TicketDesignators.TicketDesignator> ticketDesignator = new Vector<PTCFareBreakdownType.TicketDesignators.TicketDesignator>();
        ...
        public List<PTCFareBreakdownType.TicketDesignators.TicketDesignator> getTicketDesignator() {
            if (ticketDesignator == null) {
                ticketDesignator = new Vector<PTCFareBreakdownType.TicketDesignators.TicketDesignator>();
            }
