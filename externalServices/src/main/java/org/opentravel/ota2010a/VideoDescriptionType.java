...
@XmlSeeAlso({
    org.opentravel.ota2010a.VideoItemsType.VideoItem.class
})
    ...
    implements Serializable
{
    ...
    protected List<VideoDescriptionType.VideoFormat> videoFormat = new Vector<VideoDescriptionType.VideoFormat>();
    ...
    public List<VideoDescriptionType.VideoFormat> getVideoFormat() {
        if (videoFormat == null) {
            videoFormat = new Vector<VideoDescriptionType.VideoFormat>();
        }
