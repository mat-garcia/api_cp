...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_CruisePkgAvailRS.CruisePackages.CruisePackage.class,
    org.opentravel.ota2010a.OTA_CruiseShorexAvailRS.ShorexPackages.ShorexPackage.class,
    org.opentravel.ota2010a.CruiseGuestDetailType.SelectedPackages.SelectedPackage.class
})
    ...
    implements Serializable
{
    ...
    protected List<CruisePackageType.Location> location = new Vector<CruisePackageType.Location>();
    ...
    public List<CruisePackageType.Location> getLocation() {
        if (location == null) {
            location = new Vector<CruisePackageType.Location>();
        }
