...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_HotelInvAdjustRQ.Adjustments.class,
    org.opentravel.ota2010a.OTA_HotelInvSyncRQ.Adjustments.class
})
    ...
    implements Serializable
{
    ...
    protected List<AdjustmentsType.Adjustment> adjustment = new Vector<AdjustmentsType.Adjustment>();
    ...
    public List<AdjustmentsType.Adjustment> getAdjustment() {
        if (adjustment == null) {
            adjustment = new Vector<AdjustmentsType.Adjustment>();
        }
