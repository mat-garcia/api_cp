...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_VehLocDetailsNotifRQ.LocationDetails.LocationDetail.OperationSchedules.class
})
    ...
    implements Serializable
{
    ...
    protected List<OperationScheduleType> operationSchedule = new Vector<OperationScheduleType>();
    ...
    public List<OperationScheduleType> getOperationSchedule() {
        if (operationSchedule == null) {
            operationSchedule = new Vector<OperationScheduleType>();
        }
