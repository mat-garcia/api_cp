...
@XmlSeeAlso({
    OTA_CruisePNR_UpdateNotifRQ.class
})
    ...
    implements Serializable
{
    ...
    protected List<CruiseProfileType> sailingProfile = new Vector<CruiseProfileType>();
    ...
    public List<CruiseProfileType> getSailingProfile() {
        if (sailingProfile == null) {
            sailingProfile = new Vector<CruiseProfileType>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<CruiseReservationType.PaymentsDue.PaymentDue> paymentDue = new Vector<CruiseReservationType.PaymentsDue.PaymentDue>();
        ...
        public List<CruiseReservationType.PaymentsDue.PaymentDue> getPaymentDue() {
            if (paymentDue == null) {
                paymentDue = new Vector<CruiseReservationType.PaymentsDue.PaymentDue>();
            }
