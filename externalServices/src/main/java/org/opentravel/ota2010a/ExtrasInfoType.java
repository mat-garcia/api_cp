    ...
    implements Serializable
{
    ...
    protected List<ExtrasInfoType.AdditionalInfoPrompt> additionalInfoPrompt = new Vector<ExtrasInfoType.AdditionalInfoPrompt>();
    @XmlElement(name = "ParentExtras")
    protected ExtrasInfoType.ParentExtras parentExtras;
    @XmlElement(name = "ExtraLocationInfo")
    protected List<ExtrasInfoType.ExtraLocationInfo> extraLocationInfo = new Vector<ExtrasInfoType.ExtraLocationInfo>();
    ...
    public List<ExtrasInfoType.AdditionalInfoPrompt> getAdditionalInfoPrompt() {
        if (additionalInfoPrompt == null) {
            additionalInfoPrompt = new Vector<ExtrasInfoType.AdditionalInfoPrompt>();
        }
    ...
    public List<ExtrasInfoType.ExtraLocationInfo> getExtraLocationInfo() {
        if (extraLocationInfo == null) {
            extraLocationInfo = new Vector<ExtrasInfoType.ExtraLocationInfo>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<String> listOfParentRPH = new Vector<String>();
        @XmlAttribute(name = "SelectionType")
        @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
        protected String selectionType;
        @XmlAttribute(name = "RuleCode")
        ...
        public List<String> getListOfParentRPH() {
            if (listOfParentRPH == null) {
                listOfParentRPH = new Vector<String>();
            }
        ...
        implements Serializable
    {
        ...
        protected List<PeriodPriceType> period = new Vector<PeriodPriceType>();
        ...
        public List<PeriodPriceType> getPeriod() {
            if (period == null) {
                period = new Vector<PeriodPriceType>();
            }
            return this.period;
        }
