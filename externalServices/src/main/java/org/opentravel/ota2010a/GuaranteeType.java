...
@XmlSeeAlso({
    org.opentravel.ota2010a.BookingRulesType.BookingRule.AcceptableGuarantees.AcceptableGuarantee.class
})
    ...
    implements Serializable
{
    ...
    protected List<ParagraphType> guaranteeDescription = new Vector<ParagraphType>();
    ...
    public List<ParagraphType> getGuaranteeDescription() {
        if (guaranteeDescription == null) {
            guaranteeDescription = new Vector<ParagraphType>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<GuaranteeType.GuaranteesAccepted.GuaranteeAccepted> guaranteeAccepted = new Vector<GuaranteeType.GuaranteesAccepted.GuaranteeAccepted>();
        ...
        public List<GuaranteeType.GuaranteesAccepted.GuaranteeAccepted> getGuaranteeAccepted() {
            if (guaranteeAccepted == null) {
                guaranteeAccepted = new Vector<GuaranteeType.GuaranteesAccepted.GuaranteeAccepted>();
            }
