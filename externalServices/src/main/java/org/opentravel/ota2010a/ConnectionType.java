    ...
    implements Serializable
{
    ...
    protected List<ConnectionType.ConnectionLocation> connectionLocation = new Vector<ConnectionType.ConnectionLocation>();
    ...
    public List<ConnectionType.ConnectionLocation> getConnectionLocation() {
        if (connectionLocation == null) {
            connectionLocation = new Vector<ConnectionType.ConnectionLocation>();
        }
