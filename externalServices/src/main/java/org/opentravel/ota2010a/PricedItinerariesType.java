...
public class PricedItinerariesType implements Serializable
{

    @XmlElement(name = "PricedItinerary", required = true)
    protected List<PricedItinerariesType.PricedItinerary> pricedItinerary = new Vector<PricedItinerariesType.PricedItinerary>();
    ...
    public List<PricedItinerariesType.PricedItinerary> getPricedItinerary() {
        if (pricedItinerary == null) {
            pricedItinerary = new Vector<PricedItinerariesType.PricedItinerary>();
        }
