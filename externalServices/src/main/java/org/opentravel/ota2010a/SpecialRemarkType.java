...
@XmlSeeAlso({
    org.opentravel.ota2010a.SpecialReqDetailsType.SpecialRemarks.SpecialRemark.class
})
    ...
    implements Serializable
{
    ...
    protected List<SpecialRemarkType.TravelerRefNumber> travelerRefNumber = new Vector<SpecialRemarkType.TravelerRefNumber>();
    @XmlElement(name = "FlightRefNumber")
    protected List<SpecialRemarkType.FlightRefNumber> flightRefNumber = new Vector<SpecialRemarkType.FlightRefNumber>();
    ...
    public List<SpecialRemarkType.TravelerRefNumber> getTravelerRefNumber() {
        if (travelerRefNumber == null) {
            travelerRefNumber = new Vector<SpecialRemarkType.TravelerRefNumber>();
        }
    ...
    public List<SpecialRemarkType.FlightRefNumber> getFlightRefNumber() {
        if (flightRefNumber == null) {
            flightRefNumber = new Vector<SpecialRemarkType.FlightRefNumber>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<SpecialRemarkType.AuthorizedViewers.AuthorizedViewer> authorizedViewer = new Vector<SpecialRemarkType.AuthorizedViewers.AuthorizedViewer>();
        ...
        public List<SpecialRemarkType.AuthorizedViewers.AuthorizedViewer> getAuthorizedViewer() {
            if (authorizedViewer == null) {
                authorizedViewer = new Vector<SpecialRemarkType.AuthorizedViewers.AuthorizedViewer>();
            }
