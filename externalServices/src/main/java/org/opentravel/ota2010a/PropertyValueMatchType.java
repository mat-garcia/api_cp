...
@XmlSeeAlso({
    org.opentravel.ota2010a.PropertiesType.Property.class
})
    ...
    implements Serializable
{
    ...
    protected List<PropertyValueMatchType.SearchValueMatch> searchValueMatch = new Vector<PropertyValueMatchType.SearchValueMatch>();
    ...
    public List<PropertyValueMatchType.SearchValueMatch> getSearchValueMatch() {
        if (searchValueMatch == null) {
            searchValueMatch = new Vector<PropertyValueMatchType.SearchValueMatch>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<PropertyValueMatchType.Amenities.Amenity> amenity = new Vector<PropertyValueMatchType.Amenities.Amenity>();
        ...
        public List<PropertyValueMatchType.Amenities.Amenity> getAmenity() {
            if (amenity == null) {
                amenity = new Vector<PropertyValueMatchType.Amenities.Amenity>();
            }
            return this.amenity;
        }
