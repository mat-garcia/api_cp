...
@XmlSeeAlso({
    org.opentravel.ota2010a.AreaInfoType.Recreations.Recreation.MultimediaDescriptions.class,
    org.opentravel.ota2010a.HotelInfoType.Descriptions.MultimediaDescriptions.class,
    org.opentravel.ota2010a.RestaurantType.MultimediaDescriptions.class
})
    ...
    implements Serializable
{
    ...
    protected List<MultimediaDescriptionType> multimediaDescription = new Vector<MultimediaDescriptionType>();
    ...
    public List<MultimediaDescriptionType> getMultimediaDescription() {
        if (multimediaDescription == null) {
            multimediaDescription = new Vector<MultimediaDescriptionType>();
        }
