...
@XmlSeeAlso({
    org.opentravel.ota2010a.SailingCategoryInfoType.SelectedCategory.SelectedCabin.class,
    org.opentravel.ota2010a.OTA_CruiseCabinAvailRS.CabinOptions.CabinOption.class
})
    ...
    implements Serializable
{
    ...
    protected List<CabinOptionType.CabinConfiguration> cabinConfiguration = new Vector<CabinOptionType.CabinConfiguration>();
    @XmlElement(name = "MeasurementInfo")
    protected List<CabinOptionType.MeasurementInfo> measurementInfo = new Vector<CabinOptionType.MeasurementInfo>();
    ...
    public List<CabinOptionType.CabinConfiguration> getCabinConfiguration() {
        if (cabinConfiguration == null) {
            cabinConfiguration = new Vector<CabinOptionType.CabinConfiguration>();
        }
    ...
    public List<CabinOptionType.MeasurementInfo> getMeasurementInfo() {
        if (measurementInfo == null) {
            measurementInfo = new Vector<CabinOptionType.MeasurementInfo>();
        }
