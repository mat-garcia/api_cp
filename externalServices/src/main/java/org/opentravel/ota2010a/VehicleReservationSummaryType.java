    ...
    implements Serializable
{
    ...
    protected List<VehicleReservationSummaryType.ConfID> confID = new Vector<VehicleReservationSummaryType.ConfID>();
    ...
    public List<VehicleReservationSummaryType.ConfID> getConfID() {
        if (confID == null) {
            confID = new Vector<VehicleReservationSummaryType.ConfID>();
        }
        return this.confID;
    }
