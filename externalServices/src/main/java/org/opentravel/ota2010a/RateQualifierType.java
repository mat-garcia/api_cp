...
@XmlSeeAlso({
    org.opentravel.ota2010a.VehicleRentalRateType.RateQualifier.class
})
    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        protected List<RateQualifierType.RateComments.RateComment> rateComment = new Vector<RateQualifierType.RateComments.RateComment>();
        ...
        public List<RateQualifierType.RateComments.RateComment> getRateComment() {
            if (rateComment == null) {
                rateComment = new Vector<RateQualifierType.RateComments.RateComment>();
            }
