    ...
    implements Serializable
{
    ...
    protected List<CategoryOptionType.Dining> dining = new Vector<CategoryOptionType.Dining>();
    ...
    protected List<String> listOfCategoryQualifierCodes = new Vector<String>();
    ...
    public List<CategoryOptionType.Dining> getDining() {
        if (dining == null) {
            dining = new Vector<CategoryOptionType.Dining>();
        }
        return this.dining;
    }
    ...
    public List<String> getListOfCategoryQualifierCodes() {
        if (listOfCategoryQualifierCodes == null) {
            listOfCategoryQualifierCodes = new Vector<String>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<CategoryOptionType.PriceInfos.PriceInfo> priceInfo = new Vector<CategoryOptionType.PriceInfos.PriceInfo>();
        ...
        public List<CategoryOptionType.PriceInfos.PriceInfo> getPriceInfo() {
            if (priceInfo == null) {
                priceInfo = new Vector<CategoryOptionType.PriceInfos.PriceInfo>();
            }
