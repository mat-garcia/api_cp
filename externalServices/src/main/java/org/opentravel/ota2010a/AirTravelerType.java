...
@XmlSeeAlso({
    org.opentravel.ota2010a.TravelerInfoType.AirTraveler.class
})
    ...
    implements Serializable
{
    ...
    protected List<AirTravelerType.Telephone> telephone = new Vector<AirTravelerType.Telephone>();
    @XmlElement(name = "Email")
    protected List<AirTravelerType.Email> email = new Vector<AirTravelerType.Email>();
    @XmlElement(name = "Address")
    protected List<AirTravelerType.Address> address = new Vector<AirTravelerType.Address>();
    @XmlElement(name = "CustLoyalty")
    protected List<AirTravelerType.CustLoyalty> custLoyalty = new Vector<AirTravelerType.CustLoyalty>();
    @XmlElement(name = "Document")
    protected List<AirTravelerType.Document> document = new Vector<AirTravelerType.Document>();
    ...
    public List<AirTravelerType.Telephone> getTelephone() {
        if (telephone == null) {
            telephone = new Vector<AirTravelerType.Telephone>();
        }
    ...
    public List<AirTravelerType.Email> getEmail() {
        if (email == null) {
            email = new Vector<AirTravelerType.Email>();
        }
        return this.email;
    }
    ...
    public List<AirTravelerType.Address> getAddress() {
        if (address == null) {
            address = new Vector<AirTravelerType.Address>();
        }
        return this.address;
    }
    ...
    public List<AirTravelerType.CustLoyalty> getCustLoyalty() {
        if (custLoyalty == null) {
            custLoyalty = new Vector<AirTravelerType.CustLoyalty>();
        }
    ...
    public List<AirTravelerType.Document> getDocument() {
        if (document == null) {
            document = new Vector<AirTravelerType.Document>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<String> flightSegmentRPH = new Vector<String>();
        ...
        public List<String> getFlightSegmentRPH() {
            if (flightSegmentRPH == null) {
                flightSegmentRPH = new Vector<String>();
            }
