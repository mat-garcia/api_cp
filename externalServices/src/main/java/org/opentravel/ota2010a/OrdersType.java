    ...
    implements Serializable
{
    ...
    protected List<OrdersType.Order> order = new Vector<OrdersType.Order>();
    ...
    public List<OrdersType.Order> getOrder() {
        if (order == null) {
            order = new Vector<OrdersType.Order>();
        }
        return this.order;
    }
        ...
        implements Serializable
    {
        ...
        protected List<String> listOfRecipientRPH = new Vector<String>();
        ...
        public List<String> getListOfRecipientRPH() {
            if (listOfRecipientRPH == null) {
                listOfRecipientRPH = new Vector<String>();
            }
            ...
            implements Serializable
        {
            ...
            protected List<OrdersType.Order.Products.Product> product = new Vector<OrdersType.Order.Products.Product>();
            ...
            public List<OrdersType.Order.Products.Product> getProduct() {
                if (product == null) {
                    product = new Vector<OrdersType.Order.Products.Product>();
                }
                return this.product;
            }
