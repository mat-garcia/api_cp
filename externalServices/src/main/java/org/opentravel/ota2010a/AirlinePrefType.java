    ...
    implements Serializable
{
    ...
    protected List<AirlinePrefType.VendorPref> vendorPref = new Vector<AirlinePrefType.VendorPref>();
    ...
    protected List<AirportPrefType> airportOriginPref = new Vector<AirportPrefType>();
    @XmlElement(name = "AirportDestinationPref")
    protected AirportPrefType airportDestinationPref;
    @XmlElement(name = "AirportRoutePref")
    protected List<AirportPrefType> airportRoutePref = new Vector<AirportPrefType>();
    @XmlElement(name = "FareRestrictPref")
    protected List<AirlinePrefType.FareRestrictPref> fareRestrictPref = new Vector<AirlinePrefType.FareRestrictPref>();
    @XmlElement(name = "FarePref")
    protected List<AirlinePrefType.FarePref> farePref = new Vector<AirlinePrefType.FarePref>();
    @XmlElement(name = "TourCodePref")
    protected List<AirlinePrefType.TourCodePref> tourCodePref = new Vector<AirlinePrefType.TourCodePref>();
    @XmlElement(name = "FlightTypePref")
    protected List<AirlinePrefType.FlightTypePref> flightTypePref = new Vector<AirlinePrefType.FlightTypePref>();
    ...
    protected List<AirlinePrefType.CabinPref> cabinPref = new Vector<AirlinePrefType.CabinPref>();
    @XmlElement(name = "SeatPref")
    protected List<AirlinePrefType.SeatPref> seatPref = new Vector<AirlinePrefType.SeatPref>();
    @XmlElement(name = "TicketDistribPref")
    protected List<TicketDistribPrefType> ticketDistribPref = new Vector<TicketDistribPrefType>();
    ...
    protected List<AirlinePrefType.SSR_Pref> ssr_Pref = new Vector<AirlinePrefType.SSR_Pref>();
    ...
    protected List<OtherServiceInfoType> osi_Pref = new Vector<OtherServiceInfoType>();
    @XmlElement(name = "KeywordPref")
    protected List<AirlinePrefType.KeywordPref> keywordPref = new Vector<AirlinePrefType.KeywordPref>();
    ...
    public List<AirlinePrefType.VendorPref> getVendorPref() {
        if (vendorPref == null) {
            vendorPref = new Vector<AirlinePrefType.VendorPref>();
        }
    ...
    public List<AirportPrefType> getAirportOriginPref() {
        if (airportOriginPref == null) {
            airportOriginPref = new Vector<AirportPrefType>();
        }
    ...
    public List<AirportPrefType> getAirportRoutePref() {
        if (airportRoutePref == null) {
            airportRoutePref = new Vector<AirportPrefType>();
        }
    ...
    public List<AirlinePrefType.FareRestrictPref> getFareRestrictPref() {
        if (fareRestrictPref == null) {
            fareRestrictPref = new Vector<AirlinePrefType.FareRestrictPref>();
        }
    ...
    public List<AirlinePrefType.FarePref> getFarePref() {
        if (farePref == null) {
            farePref = new Vector<AirlinePrefType.FarePref>();
        }
    ...
    public List<AirlinePrefType.TourCodePref> getTourCodePref() {
        if (tourCodePref == null) {
            tourCodePref = new Vector<AirlinePrefType.TourCodePref>();
        }
    ...
    public List<AirlinePrefType.FlightTypePref> getFlightTypePref() {
        if (flightTypePref == null) {
            flightTypePref = new Vector<AirlinePrefType.FlightTypePref>();
        }
    ...
    public List<AirlinePrefType.CabinPref> getCabinPref() {
        if (cabinPref == null) {
            cabinPref = new Vector<AirlinePrefType.CabinPref>();
        }
    ...
    public List<AirlinePrefType.SeatPref> getSeatPref() {
        if (seatPref == null) {
            seatPref = new Vector<AirlinePrefType.SeatPref>();
        }
    ...
    public List<TicketDistribPrefType> getTicketDistribPref() {
        if (ticketDistribPref == null) {
            ticketDistribPref = new Vector<TicketDistribPrefType>();
        }
     ...
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSSR_Pref().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AirlinePrefType.SSR_Pref }
     * 
     * 
     */
    public List<AirlinePrefType.SSR_Pref> getSSR_Pref() {
        if (ssr_Pref == null) {
            ssr_Pref = new Vector<AirlinePrefType.SSR_Pref>();
        }
     ...
     * 
     */
    public List<OtherServiceInfoType> getOSI_Pref() {
        if (osi_Pref == null) {
            osi_Pref = new Vector<OtherServiceInfoType>();
        }
    ...
    public List<AirlinePrefType.KeywordPref> getKeywordPref() {
        if (keywordPref == null) {
            keywordPref = new Vector<AirlinePrefType.KeywordPref>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<String> airlineVendorPrefRPH = new Vector<String>();
        ...
        public List<String> getAirlineVendorPrefRPH() {
            if (airlineVendorPrefRPH == null) {
                airlineVendorPrefRPH = new Vector<String>();
            }
        ...
        implements Serializable
    {
        ...
        protected List<String> airlineVendorRPH = new Vector<String>();
        @XmlAttribute(name = "TransferAction")
        protected TransferActionType transferAction;
        ...
        public List<String> getAirlineVendorRPH() {
            if (airlineVendorRPH == null) {
                airlineVendorRPH = new Vector<String>();
            }
        ...
        implements Serializable
    {
        ...
        protected List<String> seatPreference = new Vector<String>();
        ...
        public List<String> getSeatPreference() {
            if (seatPreference == null) {
                seatPreference = new Vector<String>();
            }
        ...
        implements Serializable
    {
        ...
        /**
         * Gets the value of the ssr_Code property.
         * 
         * @return
         *     possible object is
         *     {@link String }
        ...
        /**
         * Sets the value of the ssr_Code property.
         * 
         * @param value
         *     allowed object is
         *     {@link String }
         *     
         */
        public void setSSR_Code(String value) {
            this.ssr_Code = value;
        }
