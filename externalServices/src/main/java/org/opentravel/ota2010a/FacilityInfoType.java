    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        protected List<FacilityInfoType.GuestRooms.GuestRoom> guestRoom = new Vector<FacilityInfoType.GuestRooms.GuestRoom>();
        ...
        public List<FacilityInfoType.GuestRooms.GuestRoom> getGuestRoom() {
            if (guestRoom == null) {
                guestRoom = new Vector<FacilityInfoType.GuestRooms.GuestRoom>();
            }
            ...
            implements Serializable
        {
            ...
            protected List<FacilityInfoType.GuestRooms.GuestRoom.TypeRoom> typeRoom = new Vector<FacilityInfoType.GuestRooms.GuestRoom.TypeRoom>();
            ...
            public List<FacilityInfoType.GuestRooms.GuestRoom.TypeRoom> getTypeRoom() {
                if (typeRoom == null) {
                    typeRoom = new Vector<FacilityInfoType.GuestRooms.GuestRoom.TypeRoom>();
                }
                ...
                implements Serializable
            {
                ...
                protected List<FacilityInfoType.GuestRooms.GuestRoom.Amenities.Amenity> amenity = new Vector<FacilityInfoType.GuestRooms.GuestRoom.Amenities.Amenity>();
                ...
                public List<FacilityInfoType.GuestRooms.GuestRoom.Amenities.Amenity> getAmenity() {
                    if (amenity == null) {
                        amenity = new Vector<FacilityInfoType.GuestRooms.GuestRoom.Amenities.Amenity>();
                    }
                    return this.amenity;
                }
                    ...
                    implements Serializable
                {
                    ...
                    protected List<ContactInfoRootType> contactInfo = new Vector<ContactInfoRootType>();
                    @XmlElement(name = "MultimediaDescriptions")
                    protected MultimediaDescriptionsType multimediaDescriptions;
                    @XmlElement(name = "DescriptiveText")
                    protected String descriptiveText;
                    ...
                    public List<ContactInfoRootType> getContactInfo() {
                        if (contactInfo == null) {
                            contactInfo = new Vector<ContactInfoRootType>();
                        }
                ...
                implements Serializable
            {
                ...
                protected List<String> bedTypeCode = new Vector<String>();
        ...
        implements Serializable
    {
            ...
            implements Serializable
        {
            ...
            protected List<MeetingRoomCodeType> code = new Vector<MeetingRoomCodeType>();
            ...
            public List<MeetingRoomCodeType> getCode() {
                if (code == null) {
                    code = new Vector<MeetingRoomCodeType>();
                }
                return this.code;
            }
