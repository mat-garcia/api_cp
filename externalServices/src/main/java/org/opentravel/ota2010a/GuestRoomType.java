    ...
    implements Serializable
{
    ...
    protected List<GuestRoomType.Occupancy> occupancy = new Vector<GuestRoomType.Occupancy>();
    ...
    protected List<AdditionalGuestAmountType> additionalGuestAmount = new Vector<AdditionalGuestAmountType>();
    ...
    public List<GuestRoomType.Occupancy> getOccupancy() {
        if (occupancy == null) {
            occupancy = new Vector<GuestRoomType.Occupancy>();
        }
    ...
    public List<AdditionalGuestAmountType> getAdditionalGuestAmount() {
        if (additionalGuestAmount == null) {
            additionalGuestAmount = new Vector<AdditionalGuestAmountType>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<GuestRoomType.Amenities.Amenity> amenity = new Vector<GuestRoomType.Amenities.Amenity>();
        ...
        public List<GuestRoomType.Amenities.Amenity> getAmenity() {
            if (amenity == null) {
                amenity = new Vector<GuestRoomType.Amenities.Amenity>();
            }
            return this.amenity;
        }
