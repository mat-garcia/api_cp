...
@XmlSeeAlso({
    org.opentravel.ota2010a.SailingInfoType.SelectedSailing.class
})
    ...
    implements Serializable
{
    ...
    protected List<String> listOfSailingDescriptionCode = new Vector<String>();
    ...
    public List<String> getListOfSailingDescriptionCode() {
        if (listOfSailingDescriptionCode == null) {
            listOfSailingDescriptionCode = new Vector<String>();
        }
