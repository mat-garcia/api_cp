...
@XmlSeeAlso({
    org.opentravel.ota2010a.InvBlockRoomType.RatePlans.RatePlan.class,
    org.opentravel.ota2010a.RateAmountMessageType.Rates.Rate.class,
    org.opentravel.ota2010a.HotelRatePlanType.Rates.Rate.class
})
    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        protected List<RateUploadType.AdditionalGuestAmounts.AdditionalGuestAmount> additionalGuestAmount = new Vector<RateUploadType.AdditionalGuestAmounts.AdditionalGuestAmount>();
        ...
        public List<RateUploadType.AdditionalGuestAmounts.AdditionalGuestAmount> getAdditionalGuestAmount() {
            if (additionalGuestAmount == null) {
                additionalGuestAmount = new Vector<RateUploadType.AdditionalGuestAmounts.AdditionalGuestAmount>();
            }
            ...
            implements Serializable
        {
            ...
            protected List<ParagraphType> addlGuestAmtDescription = new Vector<ParagraphType>();
            ...
            public List<ParagraphType> getAddlGuestAmtDescription() {
                if (addlGuestAmtDescription == null) {
                    addlGuestAmtDescription = new Vector<ParagraphType>();
                }
        ...
        implements Serializable
    {
        ...
        protected List<RateUploadType.BaseByGuestAmts.BaseByGuestAmt> baseByGuestAmt = new Vector<RateUploadType.BaseByGuestAmts.BaseByGuestAmt>();
        ...
        public List<RateUploadType.BaseByGuestAmts.BaseByGuestAmt> getBaseByGuestAmt() {
            if (baseByGuestAmt == null) {
                baseByGuestAmt = new Vector<RateUploadType.BaseByGuestAmts.BaseByGuestAmt>();
            }
            ...
            implements Serializable
        {
            ...
            protected List<ParagraphType> numberOfGuestsDescription = new Vector<ParagraphType>();
            @XmlAttribute(name = "Code")
            protected String code;
            ...
            public List<ParagraphType> getNumberOfGuestsDescription() {
                if (numberOfGuestsDescription == null) {
                    numberOfGuestsDescription = new Vector<ParagraphType>();
                }
        ...
        implements Serializable
    {
        ...
        protected List<GuaranteeType> guaranteePolicy = new Vector<GuaranteeType>();
        ...
        public List<GuaranteeType> getGuaranteePolicy() {
            if (guaranteePolicy == null) {
                guaranteePolicy = new Vector<GuaranteeType>();
            }
        ...
        implements Serializable
    {
        ...
        protected List<String> mealPlanCodes = new Vector<String>();
        ...
        public List<String> getMealPlanCodes() {
            if (mealPlanCodes == null) {
                mealPlanCodes = new Vector<String>();
            }
