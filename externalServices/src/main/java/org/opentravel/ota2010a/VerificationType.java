...
@XmlSeeAlso({
    org.opentravel.ota2010a.HotelResModifyType.HotelResModify.Verification.class
})
    ...
    implements Serializable
{
    ...
    protected List<VerificationType.CustLoyalty> custLoyalty = new Vector<VerificationType.CustLoyalty>();
    @XmlElement(name = "Vendor")
    protected List<CompanyNameType> vendor = new Vector<CompanyNameType>();
    ...
    protected List<VerificationType.AssociatedQuantity> associatedQuantity = new Vector<VerificationType.AssociatedQuantity>();
    ...
    public List<VerificationType.CustLoyalty> getCustLoyalty() {
        if (custLoyalty == null) {
            custLoyalty = new Vector<VerificationType.CustLoyalty>();
        }
    ...
    public List<CompanyNameType> getVendor() {
        if (vendor == null) {
            vendor = new Vector<CompanyNameType>();
        }
        return this.vendor;
    }
    ...
    public List<VerificationType.AssociatedQuantity> getAssociatedQuantity() {
        if (associatedQuantity == null) {
            associatedQuantity = new Vector<VerificationType.AssociatedQuantity>();
        }
