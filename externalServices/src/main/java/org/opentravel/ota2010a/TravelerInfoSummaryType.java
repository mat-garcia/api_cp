...
@XmlSeeAlso({
    org.opentravel.ota2010a.OTA_AirLowFareSearchRQ.TravelerInfoSummary.class,
    org.opentravel.ota2010a.OTA_AirPriceRQ.TravelerInfoSummary.class
})
    ...
    implements Serializable
{
    ...
    protected List<BigInteger> seatsRequested = new Vector<BigInteger>();
    @XmlElement(name = "AirTravelerAvail")
    protected List<TravelerInformationType> airTravelerAvail = new Vector<TravelerInformationType>();
    ...
    public List<BigInteger> getSeatsRequested() {
        if (seatsRequested == null) {
            seatsRequested = new Vector<BigInteger>();
        }
    ...
    public List<TravelerInformationType> getAirTravelerAvail() {
        if (airTravelerAvail == null) {
            airTravelerAvail = new Vector<TravelerInformationType>();
        }
        ...
        implements Serializable
    {
        ...
        protected List<TravelerInfoSummaryType.PriceRequestInformation.FareRestrictionPref> fareRestrictionPref = new Vector<TravelerInfoSummaryType.PriceRequestInformation.FareRestrictionPref>();
        @XmlElement(name = "Tax")
        ...
        protected List<TravelerInfoSummaryType.PriceRequestInformation.SegmentOverride> segmentOverride = new Vector<TravelerInfoSummaryType.PriceRequestInformation.SegmentOverride>();
        @XmlElement(name = "Account")
        protected List<TravelerInfoSummaryType.PriceRequestInformation.Account> account = new Vector<TravelerInfoSummaryType.PriceRequestInformation.Account>();
        ...
        public List<TravelerInfoSummaryType.PriceRequestInformation.FareRestrictionPref> getFareRestrictionPref() {
            if (fareRestrictionPref == null) {
                fareRestrictionPref = new Vector<TravelerInfoSummaryType.PriceRequestInformation.FareRestrictionPref>();
            }
        ...
        public List<TravelerInfoSummaryType.PriceRequestInformation.SegmentOverride> getSegmentOverride() {
            if (segmentOverride == null) {
                segmentOverride = new Vector<TravelerInfoSummaryType.PriceRequestInformation.SegmentOverride>();
            }
        ...
        public List<TravelerInfoSummaryType.PriceRequestInformation.Account> getAccount() {
            if (account == null) {
                account = new Vector<TravelerInfoSummaryType.PriceRequestInformation.Account>();
            }
            return this.account;
        }
            ...
            implements Serializable
        {
            ...
            protected List<TravelerInfoSummaryType.PriceRequestInformation.DiscountPricing.FlightReference> flightReference = new Vector<TravelerInfoSummaryType.PriceRequestInformation.DiscountPricing.FlightReference>();
            ...
            public List<TravelerInfoSummaryType.PriceRequestInformation.DiscountPricing.FlightReference> getFlightReference() {
                if (flightReference == null) {
                    flightReference = new Vector<TravelerInfoSummaryType.PriceRequestInformation.DiscountPricing.FlightReference>();
                }
