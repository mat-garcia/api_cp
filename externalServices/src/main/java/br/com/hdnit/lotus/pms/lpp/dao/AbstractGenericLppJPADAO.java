...
public abstract class AbstractGenericLppJPADAO<T> implements GenericDAO<T>, Serializable {
	...
	protected static Logger logger = Logger.getLogger(AbstractGenericLppJPADAO.class);

	private Class<T> clazz;

	@SuppressWarnings("unchecked")
	public AbstractGenericLppJPADAO() {
    ...
    public void startTransaction() {
        if (!HibernateUtilLPP.getInstance().getSessionFactory().getCurrentSession().getTransaction().isActive()) {
    ...
    public void finishTransacton() {
        ...
        if (HibernateUtilLPP.getInstance().getSessionFactory().getCurrentSession().getTransaction().isActive()) {
        	HibernateUtilLPP.getInstance().getSessionFactory().getCurrentSession().getTransaction().commit();
        }
    ...
    public Session getSession() {
        Session session = HibernateUtilLPP.getInstance().getSessionFactory().getCurrentSession();
